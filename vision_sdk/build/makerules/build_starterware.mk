...
starterware:
	...
	$(MAKE) -C $(starterware_PATH)/fatlib             $(TARGET) CORE=m4 PROFILE_m4=$(PROFILE_ipu1_0)
	$(MAKE) -C $(starterware_PATH)/fatlib/fatlib_edma $(TARGET) CORE=m4 PROFILE_m4=$(PROFILE_ipu1_0)
