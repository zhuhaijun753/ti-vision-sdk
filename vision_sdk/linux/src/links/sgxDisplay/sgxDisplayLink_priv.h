...
extern Bool fileFlag, displayFlag;

typedef struct
{
    Int32 status;
    System_VideoFrameBuffer *pVideoFrame;
    Bool newVideoFrameStatus;
} SgxDisplayLink_drvDoProcessFrames_PASA_Out;
...
//SgxDisplayLink_drvDoProcessFrames_PASA_Out  SgxDisplayLink_drvDoProcessFrames_PASA(SgxDisplayLink_Obj *pObj);
