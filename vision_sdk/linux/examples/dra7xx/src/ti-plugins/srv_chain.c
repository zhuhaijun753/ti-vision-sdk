...
void srv_get_egl_link(uint32_t *link_id, uint32_t *chain_id, uint32_t *command)
{
    *link_id = SYSTEM_LINK_ID_SRV3D_0;
    *chain_id = LVDS_SRV_3D_880x1080;
    *command = SRV3D_LINK_CMD_ACQUIRE_EGL_INFO;
}
