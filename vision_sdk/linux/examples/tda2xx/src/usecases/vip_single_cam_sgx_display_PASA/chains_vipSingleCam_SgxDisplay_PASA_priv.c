...
Int32 chains_vipSingleCam_SgxDisplay_PASA_Create(chains_vipSingleCam_SgxDisplay_PASAObj *pObj, Void *appObj){
       ...
       chains_vipSingleCam_SgxDisplay_PASA_SetLinkId(pObj);
       chains_vipSingleCam_SgxDisplay_PASA_ResetLinkPrms(pObj);

       chains_vipSingleCam_SgxDisplay_PASA_SetPrms(pObj);
       chains_vipSingleCam_SgxDisplay_PASA_SetAppPrms(pObj, appObj);

       chains_vipSingleCam_SgxDisplay_PASA_ConnectLinks(pObj);
