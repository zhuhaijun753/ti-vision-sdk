 ...
 *******************************************************************************
 *
 * \brief   Single Channel Capture then frame copy and then Sgx Display usecase function
 *
 *          This functions creates capture Link on IPU and NULL link on A15
 *          connects them through IPC links
 *
 ...
 *******************************************************************************
*/
Void chains_vipSingleCam_FrameCopy_SgxDisplay(Chains_Ctrl *chainsCfg);

//Added by Sajith
/**
 *******************************************************************************
 *
 * \brief   Single Channel Capture then Sgx Display usecase function -- Created by auto code generation tool
 *
 *          This functions creates capture Link on IPU and NULL link on A15
 *          connects them through IPC links
 *
 ...
 *******************************************************************************
*/
Void chains_test_CgTool(Chains_Ctrl *chainsCfg);
