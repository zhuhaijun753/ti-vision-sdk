...
ifeq ($(PROC_DSP2_INCLUDE),yes)
	...
	cp $(vision_sdk_PATH)/linux/src/links/sgx3Dsrv/jeep2.bmp $(LINUX_TARGETFS)/opt/vision_sdk
	cp $(vision_sdk_PATH)/linux/src/links/sgx3Dsrv/VertShader.vsh $(LINUX_TARGETFS)/opt/vision_sdk
	cp $(vision_sdk_PATH)/linux/src/links/sgx3Dsrv/FragShader.fsh $(LINUX_TARGETFS)/opt/vision_sdk
	cp $(vision_sdk_PATH)/linux/src/links/sgx3Dsrv/car.pod $(LINUX_TARGETFS)/opt/vision_sdk
