...
ifeq ($(PLATFORM),$(filter $(PLATFORM), tda2xx-evm tda2ex-evm tda2xx-mc tda3xx-evm))
    bios_PATH ?= $(TI_SW_ROOT)/os_tools/bios_6_42_02_29
    ipc_PATH  ?= $(TI_SW_ROOT)/os_tools/ipc_3_40_00_06
    ifeq ($(BUILD_OS),Windows_NT)
        xdc_PATH  ?= $(TI_SW_ROOT)/os_tools/windows/xdctools_3_31_02_38_core
    endif
    ifeq ($(BUILD_OS),Linux)
        xdc_PATH  ?= $(TI_SW_ROOT)/os_tools/linux/xdctools_3_31_02_38_core
    endif
endif
...
pvr_PATH ?= $(vision_sdk_PATH)/../ti_components/pvr_tools
endif
...
# Low-level drivers
#
bsp_PATH         ?= $(TI_SW_ROOT)/drivers/bsp_01_04_00_08
edma_PATH        ?= $(TI_SW_ROOT)/drivers/edma3_lld_02_12_00_20
starterware_PATH ?= $(TI_SW_ROOT)/drivers/starterware_01_04_00_10
...
evealg_PATH    ?= $(TI_SW_ROOT)/algorithms_codecs/eve_sw_01_10_00_00
vlib_PATH      ?= $(TI_SW_ROOT)/algorithms_codecs/vlib_c66x_3_3_0_0
...
PROC_SINGLE_CORE = no
ifeq ($(PROC_DSP_INCLUDE)$(PROC_EVE_INCLUDE)$(PROC_A15_0_INCLUDE)$(PROC_IPU1_0_INCLUDE)$(PROC_IPU1_1_INCLUDE), nononoyesno)
