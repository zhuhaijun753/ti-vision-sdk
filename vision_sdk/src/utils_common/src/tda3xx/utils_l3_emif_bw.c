...
#define DISPC_GLOBAL_MFLAG_ATTRIBUTE   ((volatile UInt32*)0x5800185CU)
#define DISPC_GFX_MFLAG_THRESHOLD      ((volatile UInt32*)0x58001860U)
#define DISPC_VID1_MFLAG_THRESHOLD     ((volatile UInt32*)0x58001864U)
#define DISPC_VID2_MFLAG_THRESHOLD     ((volatile UInt32*)0x58001868U)
