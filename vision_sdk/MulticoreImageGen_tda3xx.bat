...
"%Tools_path%\multicore_image_generator\tda3xx\MulticoreImageGen.exe" LE %Dev_ID% %Out_Path%\AppImage_LE %IPU1_CPU0% %App_IPU1_CPU0_RPRC% %IPU1_CPU1% %App_IPU1_CPU1_RPRC% %DSP1_CPU% %App_DSP1_RPRC% %DSP2_CPU% %App_DSP2_RPRC% %EVE1_CPU% %App_EVE1_RPRC% %IPU1_CPU_SMP% %App_IPU1_RPRC%

"%Tools_path%\multicore_image_generator\tda3xx\MulticoreImageGen.exe" BE %Dev_ID% %Out_Path%\AppImage_BE %IPU1_CPU0% %App_IPU1_CPU0_RPRC% %IPU1_CPU1% %App_IPU1_CPU1_RPRC% %DSP1_CPU% %App_DSP1_RPRC% %DSP2_CPU% %App_DSP2_RPRC% %EVE1_CPU% %App_EVE1_RPRC% %IPU1_CPU_SMP% %App_IPU1_RPRC%
)
