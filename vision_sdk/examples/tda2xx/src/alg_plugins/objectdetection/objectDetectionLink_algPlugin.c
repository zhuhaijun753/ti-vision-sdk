                ...
                else
                {
                    ...
                    #if 0
                    {
                        ...
                        for (i = 0; i < pObjectDataOutput->numObjects; i++)
                        {
                            ...
                            Vps_printf(" ALG_OBJECT_DETECT: #%d: Type = %d: %d x %d @ (%d, %d), Score = %d, Scale = %6.4f\n",
                                i,
                                objectDataDesc.objType,
                                objectDataDesc.objWidth,
                                objectDataDesc.objHeight,
                                objectDataDesc.xPos,
                                objectDataDesc.yPos,
                                objectDataDesc.objScore,
                                objectDataDesc.objScale
                                );
                        }
                    }
                    #endif
    ...
    switch(pAlgLinkControlPrm->controlCmd)
    {
        case ALGORITHM_LINK_OBJECT_DETECT_CMD_ENABLE_ALG:
            ...
            else
            {
                ...
                {
                    pObjectDetectObj->inArgs.pdConfig.classifierTypePD
                        = pEnableAlg->classifierTypePD;
                    ...
                    pObjectDetectObj->inArgs.tsrConfig.classifierTypeTSR
                        = pEnableAlg->classifierTypeTSR;
