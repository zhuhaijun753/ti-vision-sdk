    ...
    if (inputBufList.numBuf)
    {
        for (bufId = 0; bufId < inputBufList.numBuf; bufId++)
        {
            ...
            else
            {
                ...
                pFPlaneObj->yuvPaddingTime += curTime;
                ...
                if((pFPlaneObj->frameCount > 0) && (pFPlaneObj->frameCount%300==0))
                {
                    ...
                    Vps_printf(
                        " ALG_FEATURE_PLANE_COMPUTE: yuvPadding (avg) = %d us\n",
                            pFPlaneObj->yuvPaddingTime/pFPlaneObj->frameCount
                        );
                    Vps_printf(
