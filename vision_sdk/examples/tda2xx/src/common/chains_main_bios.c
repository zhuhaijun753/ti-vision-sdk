...
char gChains_menuUseCases[] = {
    ...
    #endif
    #ifdef RADAR_INCLUDE
    "\r\n 9: RADAR Use-cases, (TDA2x MonsterCam ONLY)"
    #endif
...
char gChains_menuIssUsecases[] = {
    ...
    "\r\n 3: 4CH ISS capture + ISS ISP + Simcop + Surround View (DSP1) +  Display"
    "\r\n 4: 1CH ISS capture (AR0132) + ISS ISP Monochrome +  Display"
    "\r\n "
    "\r\n x: Exit "
    "\r\n "
    "\r\n Enter Choice: "
            ...
            case '1':
                    ...
                    (Bsp_platformIsTda3xxFamilyBuild()))
                {
                    if(Board_isMultiDesConnected())
                    {
                        ...
                        {
                           gChains_usecaseCfg.numLvdsCh = 3;
    ...
    while(!done)
    {
        ...
        switch(ch)
        {
            ...
            case '2':
                if(Bsp_platformIsTda3xxFamilyBuild())
                {
                    Chains_issMultCaptIspSv_Display(&gChains_usecaseCfg);
                }
                else
                {
                    Vps_printf(" ### Cannot run usecase. Usecase not supported on this platform \n");
