...
#define SV_WIDTH                  (1280)
#define SV_HEIGHT                 (720)
...
#define SV_HOR_WIDTH              (1024)
#define SV_HOR_HEIGHT             (768)
...
Void chains_lvdsVipSurroundView_SetAppPrms(chains_lvdsVipSurroundViewObj *pUcObj, Void *appObj)
{
    ...
    pUcObj->Display_svPrm.rtParams.posX       = 0;
    pUcObj->Display_svPrm.rtParams.posY       = 0;
