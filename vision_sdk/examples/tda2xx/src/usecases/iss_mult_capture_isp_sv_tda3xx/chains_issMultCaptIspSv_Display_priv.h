...
#ifndef _chains_issMultCaptIspSv_Display_H_
#define _chains_issMultCaptIspSv_Display_H_
...
} chains_issMultCaptIspSv_DisplayObj;

Void chains_issMultCaptIspSv_Display_SetLinkId(chains_issMultCaptIspSv_DisplayObj *pObj);

Void chains_issMultCaptIspSv_Display_ResetLinkPrms(chains_issMultCaptIspSv_DisplayObj *pObj);

Void chains_issMultCaptIspSv_Display_SetPrms(chains_issMultCaptIspSv_DisplayObj *pObj);

Void chains_issMultCaptIspSv_Display_ConnectLinks(chains_issMultCaptIspSv_DisplayObj *pObj);

Int32 chains_issMultCaptIspSv_Display_Create(chains_issMultCaptIspSv_DisplayObj *pObj, Void *appObj);

Int32 chains_issMultCaptIspSv_Display_Start(chains_issMultCaptIspSv_DisplayObj *pObj);

Int32 chains_issMultCaptIspSv_Display_Stop(chains_issMultCaptIspSv_DisplayObj *pObj);

Int32 chains_issMultCaptIspSv_Display_Delete(chains_issMultCaptIspSv_DisplayObj *pObj);

Void chains_issMultCaptIspSv_Display_printBufferStatistics(chains_issMultCaptIspSv_DisplayObj *pObj);

Void chains_issMultCaptIspSv_Display_printStatistics(chains_issMultCaptIspSv_DisplayObj *pObj);

Void chains_issMultCaptIspSv_Display_SetAppPrms(chains_issMultCaptIspSv_DisplayObj *pObj, Void *appObj);

#endif /* _chains_issMultCaptIspSv_Display_H_ */
