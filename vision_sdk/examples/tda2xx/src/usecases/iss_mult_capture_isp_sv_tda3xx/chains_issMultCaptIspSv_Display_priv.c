...
Int32 chains_issMultCaptIspSv_Display_Create(chains_issMultCaptIspSv_DisplayObj *pObj, Void *appObj){
       ...
       chains_issMultCaptIspSv_Display_SetLinkId(pObj);
       chains_issMultCaptIspSv_Display_ResetLinkPrms(pObj);

       chains_issMultCaptIspSv_Display_SetPrms(pObj);
       chains_issMultCaptIspSv_Display_SetAppPrms(pObj, appObj);

       chains_issMultCaptIspSv_Display_ConnectLinks(pObj);
