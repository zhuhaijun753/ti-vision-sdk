                    ...
                    )
{
    ...
    pPrm->dumpFramesMemoryAddr = (UInt8 *)FRAMES_DUMP_TO_MEMORY_ADDR;
...
Void chains_vipSingleCameraObjectDetect_SetAppPrms(chains_vipSingleCameraObjectDetectObj *pUcObj, Void *appObj)
{
    ...
    pUcObj->Display_algPrm.rtParams.tarWidth = pObj->captureOutWidth;
    pUcObj->Display_algPrm.rtParams.tarHeight = pObj->captureOutHeight;
    pUcObj->Display_algPrm.rtParams.posX = (pObj->displayWidth - pObj->captureOutWidth)/2;
    pUcObj->Display_algPrm.rtParams.posY = (pObj->displayHeight - pObj->captureOutHeight)/2;
