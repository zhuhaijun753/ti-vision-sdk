...
)
{
    ...
    pObjectDetectPrm->imgFrameHeight = height;
    pObjectDetectPrm->imgFrameWidth  = width;
...
Void ChainsCommon_Analytics_SwitchPdTsr()
{
    ...
    enableAlg.enableAdvConfig = FALSE;
        ...
        )
{
    ...
    pSync_algPrm->syncDelta = 0x7FFFFFFF;
    pSync_algPrm->syncThreshold = 0x7FFFFFFF;
