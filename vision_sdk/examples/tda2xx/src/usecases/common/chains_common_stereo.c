...
)
{
    if(pOrgPrm)
    {
        pOrgPrm->syncDelta = SYNC_DELTA_IN_MSEC;
        pOrgPrm->syncThreshold = SYNC_DROP_THRESHOLD_IN_MSEC;
    }

    if(pDispPrm)
    {
        pDispPrm->syncDelta = SYNC_DELTA_IN_MSEC;
        pDispPrm->syncThreshold = SYNC_DROP_THRESHOLD_IN_MSEC;
    }
}
