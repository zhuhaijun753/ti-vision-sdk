 ...
 * \defgroup ALGORITHM_LINK_FEATUREPLANECOMPUTATION Algorithm Plugin:
 *              Feature Plane Computation API
 ...
 *   \addtogroup ALGORITHM_LINK_FEATURE_PLANE_COMPUTE_CMD Algorithm Plugin:
 *                   Feature Plane Compute Control Commands
 *   @{
 *
 *******************************************************************************
 */
