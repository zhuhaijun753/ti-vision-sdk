...
#ifndef SGXDISPLAY_LINK_H_
#define SGXDISPLAY_LINK_H_
...
static inline Void SgxDisplayLink_CreateParams_Init(
                                  SgxDisplayLink_CreateParams *prm)
{
    memset(prm, 0, sizeof(SgxDisplayLink_CreateParams));
