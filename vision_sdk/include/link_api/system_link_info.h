...
#define SYSTEM_LINK_CH_INFO_GET_FLAG_BUF_TYPE(container)                  \
            SystemUtils_unpack_bitfield((container), 0x0000000FU, 0x0U)
...
#define SYSTEM_LINK_CH_INFO_GET_FLAG_BITSTREAM_FORMAT(container)          \
            SystemUtils_unpack_bitfield((container), 0x000000F0U, (UInt32)4U)
...
#define SYSTEM_LINK_CH_INFO_GET_FLAG_SCAN_FORMAT(container)               \
            SystemUtils_unpack_bitfield((container), 0x00000100U, (UInt32)8U)
...
#define SYSTEM_LINK_CH_INFO_GET_FLAG_MEM_TYPE(container)                  \
            SystemUtils_unpack_bitfield((container), 0x00000200U, (UInt32)9U)
...
#define SYSTEM_LINK_CH_INFO_GET_FLAG_IS_RT_PRM_UPDATE(container)          \
            SystemUtils_unpack_bitfield((container), 0x00000400U, (UInt32)10U)
...
#define SYSTEM_LINK_CH_INFO_GET_FLAG_DATA_FORMAT(container)               \
            SystemUtils_unpack_bitfield((container), 0x0FFFF000U, (UInt32)12U)
