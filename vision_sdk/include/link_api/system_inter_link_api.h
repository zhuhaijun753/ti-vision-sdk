...
#define SYSTEM_BUFFER_FLAG_GET_BUF_TYPE(container)                        \
            SystemUtils_unpack_bitfield((container), 0x0000000FU, 0U)
...
#define SYSTEM_BUFFER_FLAG_GET_CH_NUM(container)                          \
            SystemUtils_unpack_bitfield((container), 0x00000FF0U, 4U)
...
#define SYSTEM_BUFFER_FLAG_GET_PAYLOAD_SIZE(container)                    \
            SystemUtils_unpack_bitfield((container), 0x00FFF000U, 12U)
