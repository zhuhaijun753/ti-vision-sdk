...
void Init()
{
    ...
    RegisterHandler("object_detect_set_dynamic_params", handleObjectDetectSetDynamicParams, 11);
...
void ShowUsage()
{
    ...
    printf("#\n");
    printf("# object_detect_set_dynamic_params <enablePD> <classifierTypePD> <trackingMethodPD> <softCascadeThPD> <strongCascadeThPD>\n");
    printf("#                <enableTSR> <classifierTypeTSR> <trackingMethodTSR> <recognitionMethodTSR> <softCascadeThTSR> <strongCascadeThTSR>\n");
    printf("#\n");
