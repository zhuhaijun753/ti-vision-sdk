...
public class framework_components_3_40_01_04
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("framework_components_3_40_01_04.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("framework_components_3_40_01_04", new Value.Obj("framework_components_3_40_01_04", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("framework_components_3_40_01_04.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "framework_components_3_40_01_04"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "framework_components_3_40_01_04", Value.DEFAULT, false);
        pkgV.bind("$name", "framework_components_3_40_01_04");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "framework_components_3_40_01_04.");
        ...
        sb.append("var pkg = xdc.om['framework_components_3_40_01_04'];\n");
        sb.append("if (pkg.$vers.length >= 3) {\n");
            sb.append("pkg.$vers.push(Packages.xdc.services.global.Vers.getDate(xdc.csd() + '/..'));\n");
        sb.append("}\n");
        sb.append("if ('framework_components_3_40_01_04$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['framework_components_3_40_01_04$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['framework_components_3_40_01_04$$stat$root'];\n");
        sb.append("}\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "framework_components_3_40_01_04")).add(pkgV);
    }
