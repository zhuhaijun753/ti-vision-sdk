...
public class ti_sdo_fc_ires_hdvicp
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("pkg.build.libraries = [\n");
            ...
            sb.append("'lib/whole_program/hdvicp2.aem4',\n");
            sb.append("'lib/whole_program_debug/hdvicp2.aem4',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            ...
            sb.append("['lib/whole_program/hdvicp2.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
            sb.append("['lib/whole_program_debug/hdvicp2.aem4', {target: 'ti.targets.arm.elf.M4', suffix: 'em4'}],\n");
        sb.append("];\n");
