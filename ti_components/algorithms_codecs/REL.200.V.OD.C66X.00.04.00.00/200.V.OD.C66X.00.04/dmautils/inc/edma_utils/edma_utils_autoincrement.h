 ...
 *          This utility assumes that following equation is statified :
 ...
 *              be careful that for non-overlapping increment usecase roiWidth
 *              should not include the last increment in X direction in order
 *              to satisfy the above stated equation.
 *
 *  @field t roiHeight
 *             Height of the region of interest in an image frame. User should
 *              be careful that for non-overlapping increment usecase roiHeight
 *              should not include the last increment in Y direction.
 *
 *  @field blkWidth
 *             Block Width
 *
