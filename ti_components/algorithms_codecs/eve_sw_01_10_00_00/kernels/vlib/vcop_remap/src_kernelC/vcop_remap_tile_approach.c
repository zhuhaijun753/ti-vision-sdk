...
int32_t vcop_remap_tile_approach_init(
    ...
    tluFracArray     = (uint8_t  *)(*((uint16_t (*)[])((void *)tluIndexArray)) + ALIGN_TLU(maxNumPixelsinTile));
    tluScOffsetArray = (uint16_t *)(*((uint8_t  (*)[])((void *)tluFracArray))   + ALIGN_TLU(maxNumPixelsinTile));
    ...
    if (srcFormat== YUV_420SP) {
        ...
        tluScOffsetArrayUV  = (uint16_t*)(*((uint16_t (*)[])((void *)tluIndexArrayV)) + ALIGN_2SIMD(maxNumEvenPixelsinTile));
        ...
        if (params->interpolationChroma== BILINEAR) {
            xFracArrayUV = (uint8_t*)(*((uint16_t (*)[])((void *)tluScOffsetArrayV)) + ALIGN_2SIMD(maxNumEvenPixelsinTile) + 32U);
            yFracArrayUV = (uint8_t*)(*((uint8_t (*)[])((void *)xFracArrayUV)) + ALIGN_2SIMD(maxNumEvenPixelsinTile));
        } else {
            xFracArrayUV = NULL;
            yFracArrayUV = NULL;
        }
        ...
        (*scattered_ofst)[0]= 0;  (*scattered_ofst)[1]= 1;  (*scattered_ofst)[2]= 0;  (*scattered_ofst)[3]= 1;
        (*scattered_ofst)[4]= 0;  (*scattered_ofst)[5]= 1;  (*scattered_ofst)[6]= 0;  (*scattered_ofst)[7]= 1;
    ...
    src_stride_ptr = (uint16_t *)(interpolationBuf0Ptr + ((uint16_t)2 * sizeof(uint16_t) * ALIGN_2SIMD(maxNumPixelsinTile)));
    ...
    *(src_stride_ptr) = src_stride;
    ...
    src_uv = (uint8_t*)(*((uint8_t (*)[])((void *)src)) + ALIGN_TLU(inputTileSize));
    ...
    if ((srcFormat == YUV_422ILE) || (srcFormat == YUV_422IBE) || (srcFormat == YUV_420SP)) {
        ...
        /* For 420, Chroma TLU Index Calculate kernel is initialized */
            ...
            if (params->interpolationChroma== BILINEAR) {
                ...
                vcop_chromaTLUIndexCalcBilInterpolate_init(tluIndexArray, tluFracArray, tluScOffsetArray, numEvenMappedPixels, src_stride, \
                ...
                vcop_chromaTLUIndexCalcNNInterpolate_init(tluIndexArray, tluScOffsetArray, numEvenMappedPixels, src_stride, src_stride_q16, \
