...
/*                                                                          */
/*     NAME                                                                 */
/*     vcop_vec_bin_image_dilate_mask_cn                                    */
/*                                                                          */
/*     USAGE                                                                */
...
)
{
    ...
    char mask00 = (((mask[0] > 0) << 31) >> 31);
    char mask01 = (((mask[1] > 0) << 31) >> 31);
    char mask02 = (((mask[2] > 0) << 31) >> 31);
    char mask10 = (((mask[3] > 0) << 31) >> 31);
    char mask11 = (((mask[4] > 0) << 31) >> 31);
    char mask12 = (((mask[5] > 0) << 31) >> 31);
    char mask20 = (((mask[6] > 0) << 31) >> 31);
    char mask21 = (((mask[7] > 0) << 31) >> 31);
    char mask22 = (((mask[8] > 0) << 31) >> 31);
...
/* ======================================================================== */
/*  End of file:  vcop_vec_bin_image_dilate_mask_c.c                        */
/* ------------------------------------------------------------------------ */
/*            Copyright (c) 2010 Texas Instruments, Incorporated.           */
/*                           All Rights Reserved.                           */
/* ======================================================================== */
