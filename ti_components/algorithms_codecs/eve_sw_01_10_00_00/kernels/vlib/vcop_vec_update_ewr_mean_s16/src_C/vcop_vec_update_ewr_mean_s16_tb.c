...
/*                                                                          */
/*  NAME                                                                    */
/*      vcop_vec_update_ewr_mean_s16-tb                                     */
/*                                                                          */
...
int main()
{
    ...
    vcop_vec_update_ewr_mean_s16_cn (runningMean,newLuma,mask32packed, 
                                                  UPDATE_RATE,NUM_PIXELS);
...
/* ======================================================================== */
/*  End of file:  vcop_vec_update_ewr_mean_s16_tb.c                         */
/*--------------------------------------------------------------------------*/
/*      Copyright (C) 2010 Texas Instruments Incorporated.                  */
/*                          All Rights Reserved.                            */
/* ======================================================================== */
