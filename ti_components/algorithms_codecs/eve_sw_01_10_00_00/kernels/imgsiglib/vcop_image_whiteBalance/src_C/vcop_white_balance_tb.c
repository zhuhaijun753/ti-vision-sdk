...
int main()
{
  ...
  /*---------------------------------------------------------------------*/
  natc_bayer_white_balance(CFA_short,/*Input image buffer,Result is stored back in same buffer */
                           CFA_short,
                           INPUT_IMG_WIDTH,
                           INPUT_IMG_HEIGHT,
                           GAIN_FACTOR_R,
  ...
  /*--------------------------------------------------------------------------*/
  status = verify_output(CFA_short,Ref_CFA_short_out,BLK_HEIGHT,BLK_WIDTH);
  if(status)
  {
  ...
  else
  {
    ...
    /*---------------------------------------------------------------------*/
    print_output(CFA_short,INPUT_IMG_HEIGHT,INPUT_IMG_WIDTH);
  }
