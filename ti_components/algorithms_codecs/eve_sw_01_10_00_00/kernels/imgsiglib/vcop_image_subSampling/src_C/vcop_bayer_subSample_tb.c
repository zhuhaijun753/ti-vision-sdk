...
/* ===========================================================================*/
/*   @file : vcop_bayer_subSample_tb.c                                    */

/*   @brief  : Driver file for testing 16x sub sampling   */
...
int main()
{
  ...
  /*---------------------------------------------------------------------*/
  vcop_bayer_subSample(bayer_input,
                       subSample_out,
                       BLK_WIDTH,
                       BLK_HEIGHT,
                       SUB_SAMPLE_X,
  ...
  /*--------------------------------------------------------------------------*/
  status = verify_output(subSample_out,subSample_out_Ref,BLK_HEIGHT,BLK_WIDTH);
  if(status)
  {
  ...
  else
  {
    ...
    /*---------------------------------------------------------------------*/
    print_output(subSample_out,INPUT_IMG_HEIGHT,INPUT_IMG_WIDTH);
  }
