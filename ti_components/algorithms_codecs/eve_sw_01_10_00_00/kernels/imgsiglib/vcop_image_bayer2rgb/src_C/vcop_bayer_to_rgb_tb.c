...
/* ===========================================================================*/
/*   @file : vcop_bayer_to_rgb_tb.c                                    */

/*   @brief  : Driver file for testing bayer to RGB conversion   */
...
/*---------------------------------------------------------------------------*/
/*Output R component output*/
/*---------------------------------------------------------------------------*/
#pragma DATA_SECTION(R, "Cdata");
#pragma DATA_ALIGN(R, 32);
unsigned short R[(INPUT_IMG_WIDTH * INPUT_IMG_HEIGHT)+64] = {0};

/*---------------------------------------------------------------------------*/
/*Output G component output*/
/*---------------------------------------------------------------------------*/
#pragma DATA_SECTION(G, "Cdata");
#pragma DATA_ALIGN(G, 32);
unsigned short G[(INPUT_IMG_WIDTH * INPUT_IMG_HEIGHT)+64] = {0};

/*---------------------------------------------------------------------------*/
/*Output B component output*/
/*---------------------------------------------------------------------------*/
#pragma DATA_SECTION(B, "Cdata");
#pragma DATA_ALIGN(B, 32);
unsigned short B[(INPUT_IMG_WIDTH * INPUT_IMG_HEIGHT)+64] = {0};
...
int main()
{
  ...
  else
  {
    ...
    /*  If there is a mismatch, print out a memory trace*/
    /*---------------------------------------------------------------------*/
    print_output(G,INPUT_IMG_HEIGHT,INPUT_IMG_WIDTH);
  }
