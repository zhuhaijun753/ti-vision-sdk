...
static BAM_Status BAM_execute(const BAM_GraphDef *graphDef)
{
    ...
    kernelExecFuncDbArray= (const BAM_KernelExecFuncDBdef (*)[])(void*)(graphDef->kernelDBDef->kernelExecFuncDB);
        ...
        else
        {
            ...
            if ((*node)[nodeIndex].kernelInfo.coreType== BAM_EVE_ARP32) {
                if (kernelComputeTemp!= NULL) {
                    ...
                    kernelCompute[computeNodeIndex]= &BAM_ARP32_computeWrapper;
