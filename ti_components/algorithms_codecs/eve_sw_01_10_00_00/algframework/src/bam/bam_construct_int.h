...
/**
 *  @file       bam_construct_int.h
 *
 *  @brief      This file defines interfnal structures and functions for BAM Graph Construction
 */
...
typedef struct _bam_graphdef
{
    ...
    BAM_GraphDefParams params;      /**< Status showing state of the graph. initialized or non-initialized */
