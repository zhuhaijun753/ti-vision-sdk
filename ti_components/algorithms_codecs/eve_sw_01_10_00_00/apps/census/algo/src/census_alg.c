...
{
        {
                (void *)&CENSUS_TI_VISION_FXNS, /* module ID */
        ...
        const IALG_Params * params)
{
    ...
    CENSUS_TI_CreateParams * createParams =
            (CENSUS_TI_CreateParams*)(void*)params;
    ...
    algHandle->ivision = (IVISION_Fxns *)&CENSUS_TI_VISION_FXNS;
        ...
        IVISION_OutArgs *outArgs)
{
    ...
    outArgs->inFreeBufIDs[CENSUS_BUFDESC_IN]    = 0 ;

    outArgs->outFreeBufIDs[CENSUS_BUFDESC_OUT]=
            (*outBufDesc)[CENSUS_BUFDESC_OUT]->bufferId;
    outArgs->outFreeBufIDs[CENSUS_BUFDESC_OUT]   = 0;
