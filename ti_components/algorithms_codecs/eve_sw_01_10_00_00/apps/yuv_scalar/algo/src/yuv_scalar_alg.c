...
{
        {
                (void *)&YUV_SCALAR_TI_VISION_FXNS, /* module ID */
        ...
        IALG_MemRec memRec[])
{
    ...
    YUV_SCALAR_TI_CreateParams * createParams =
            (YUV_SCALAR_TI_CreateParams*)(void*)params;
        ...
        const IALG_Params * params)
{
    ...
    algHandle->ivision = (IVISION_Fxns *)&YUV_SCALAR_TI_VISION_FXNS;
