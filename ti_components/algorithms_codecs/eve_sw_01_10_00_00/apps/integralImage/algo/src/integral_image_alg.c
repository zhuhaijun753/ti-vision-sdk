...
{
        {
                (void *)&INTEGRAL_IMAGE_TI_VISION_FXNS, /* module ID */
        ...
        IALG_MemRec memRec[])
{
    INTEGRAL_IMAGE_TI_CreateParams * createParams =
            (INTEGRAL_IMAGE_TI_CreateParams*)(void*)params;
        ...
        const IALG_Params *params)
{
    ...
    algHandle->ivision = (IVISION_Fxns *)&INTEGRAL_IMAGE_TI_VISION_FXNS;
...
/* RESET_MISRA("16.7")  -> Reset rule 16.7  */
{
    ...
    outArgs->outFreeBufIDs[INTEGRAL_IMAGE_BUFDESC_IN_TOTAL]   = 0;
