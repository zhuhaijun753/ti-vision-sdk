...
{
        {
                (void *)&EDGE_DETECTOR_TI_VISION_FXNS, /* module ID */
        ...
        IALG_MemRec memRec[])
{
    ...
    EDGE_DETECTOR_TI_CreateParams* createParams = (EDGE_DETECTOR_TI_CreateParams * )(void *)params;
        ...
        const IALG_Params * params)
{
    ...
    algHandle->ivision = (IVISION_Fxns *)&EDGE_DETECTOR_TI_VISION_FXNS;
