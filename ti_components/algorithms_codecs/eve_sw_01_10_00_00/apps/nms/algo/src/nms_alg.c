...
{
        {
                (void *)&NMS_TI_VISION_FXNS, /* module ID */
        ...
        const IALG_Params * params)
{
    ...
    nmsCreateParams.inmsCreateParams = (NMS_TI_CreateParams*)(void *)params;
    ...
    algHandle->ivision = (IVISION_Fxns *)&NMS_TI_VISION_FXNS;
        ...
        IALG_Params *outParams)
{
  ...
  NMS_TI_ControlInArgs * ctrlInArgs = ( NMS_TI_ControlInArgs*)(void *) inParams;
