...
{
        {
                (void *)&IMAGE_PYRAMID_U8_TI_VISION_FXNS, /* module ID */
        ...
        const IALG_Params params[])
{
    ...
    IMAGE_PYRAMID_U8_TI_CreateParams * createParams =
            (IMAGE_PYRAMID_U8_TI_CreateParams*)(void*)params;
    ...
    algHandle->ivision = (IVISION_Fxns *)&IMAGE_PYRAMID_U8_TI_VISION_FXNS;
