...
{
  {
    (void *)&HOUGH_FOR_LINES_TI_VISION_FXNS, /* module ID */
                            ...
                            const IALG_Params * params)
{
  ...
  algHandle->ivision = (IVISION_Fxns *)&HOUGH_FOR_LINES_TI_VISION_FXNS;
