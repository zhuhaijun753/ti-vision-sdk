...
{
        {
                (void *)&YUV_PADDING_TI_VISION_FXNS, /* module ID */
        ...
        IALG_MemRec memRec[])
{
    ...
    YUV_PADDING_TI_CreateParams * createParams =
            (YUV_PADDING_TI_CreateParams*)(void*)params;
        ...
        const IALG_Params * params)
{
    ...
    algHandle->ivision = (IVISION_Fxns *)&YUV_PADDING_TI_VISION_FXNS;
