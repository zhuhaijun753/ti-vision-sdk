...
{
        {
                (void *)&BIN_IMAGE_TO_LIST_TI_VISION_FXNS, /* module ID */
...
const IRES_Fxns BIN_IMAGE_TO_LIST_TI_IRES = {
        (void *)&BIN_IMAGE_TO_LIST_TI_IRES,
        ...
        IALG_MemRec memRec[NUM_MEMRECS])
{
    ...
    BIN_IMAGE_TO_LIST_TI_CreateParams * createParams = ( BIN_IMAGE_TO_LIST_TI_CreateParams *) (void *)params;
    /*---------------------------------------------------------*/
        ...
        const IALG_Params * params)
{
    ...
    createParams.icreateParams = (BIN_IMAGE_TO_LIST_TI_CreateParams*)(void *)params;
    ...
    algHandle->ivision = (IVISION_Fxns *)&BIN_IMAGE_TO_LIST_TI_VISION_FXNS;
