                  ...
                  void * edmaContext,  void * params)
{
  ...
  updateParams.updateMask   = EDMA_UTILS_AUTOINCREMENT_1D_UPDATE_MASK_ALL &
                                (~EDMA_UTILS_AUTOINCREMENT_1D_UPDATE_MASK_INTERMEMPTR);
...
static BAM_Status BAM_DMA_CUSTOM_SELECT_LIST_ELEM_OUT_trigger(void * edmaContext)
{
  ...
  if ( context->blkIdxOut != -1 )
  {
    ...
    context->blkWidth[0]     = 4U*(*context->pIntListSize[context->pingPongFlag]);
