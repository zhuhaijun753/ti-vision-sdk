...
{
    {
        (void *)&REMAP_MERGE_TI_VISION_FXNS,  /* module ID */
                                      ...
                                      const IALG_Params *params)
{
    ...
    REMAP_MERGE_TI_CreateParams *createParams = (REMAP_MERGE_TI_CreateParams *)(void *)params;
    REMAP_MERGE_TI_graphCreateParams graphCreateParams;
    int32_t status = IALG_EOK;
    int32_t bamStatus = BAM_S_SUCCESS;

    algHandle->ivision     = (IVISION_Fxns *)&REMAP_MERGE_TI_VISION_FXNS;
