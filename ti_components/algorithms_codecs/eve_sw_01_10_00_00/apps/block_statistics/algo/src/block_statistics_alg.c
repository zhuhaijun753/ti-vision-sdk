...
{
  {
      (void *)&BLOCK_STATISTICS_TI_VISION_FXNS, /* module ID */
                     ...
                     const IALG_Params *params)
{
  ...
  BLOCK_STATISTICS_TI_CreateParams *createParams = (BLOCK_STATISTICS_TI_CreateParams*)(void *)params;
  ...
  algHandle->ivision = (IVISION_Fxns *)&BLOCK_STATISTICS_TI_VISION_FXNS;
