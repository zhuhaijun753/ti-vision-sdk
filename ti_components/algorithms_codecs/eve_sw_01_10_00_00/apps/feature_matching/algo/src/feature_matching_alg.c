...
{
  {
      (void *)&FEATURE_MATCHING_TI_VISION_FXNS, /* module ID */
                     ...
                     const IALG_Params *params)
{
  int32_t status = IALG_EOK;
  int32_t bamStatus;
  FEATURE_MATCHING_TI_CreateParams *createParams = (FEATURE_MATCHING_TI_CreateParams*)(void *)params;
  ...
  algHandle->ivision = (IVISION_Fxns *)&FEATURE_MATCHING_TI_VISION_FXNS;
