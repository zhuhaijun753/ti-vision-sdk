...
{
        {
                (void *)&HARRIS_CORNER_DETECTION_32_TI_VISION_FXNS, /* module ID */
...
const IRES_Fxns HARRIS_CORNER_DETECTION_32_TI_IRES = {
        (void *)&HARRIS_CORNER_DETECTION_32_TI_IRES,
        ...
        const IALG_Params * params)
{
    ...
    HARRIS_CORNER_DETECTION_32_TI_CreateParams * createParams =
            (HARRIS_CORNER_DETECTION_32_TI_CreateParams*)(void*)params;
    ...
    algHandle->ivision = (IVISION_Fxns *)&HARRIS_CORNER_DETECTION_32_TI_VISION_FXNS;
...
{
    int32_t status = IALG_EOK;
    HARRIS_CORNER_DETECTION_32_TI_ControlInParams *controlInParams= (HARRIS_CORNER_DETECTION_32_TI_ControlInParams *)(void*)inParams;
