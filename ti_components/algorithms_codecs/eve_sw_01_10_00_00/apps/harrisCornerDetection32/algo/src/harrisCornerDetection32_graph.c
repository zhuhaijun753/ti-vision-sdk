...
/*RESET_MISRA("16.7")  -> Reset rule 16.7  */
    ...
    outStride= ALIGN_SIMD(blockWidth - harrisBorder);
    ...
    outStride= ALIGN_SIMD(blockWidth - nmsBorder);
    ...
    assignDMAautoIncrementParams(&graphArgs->dmaReadKernelArgs.transferProp[BAM_SOURCE_NODE_PORT1],
            (graphArgs->createParams->imgFrameWidth + totalBorderRequired)*sizeof(uint8_t), /* roiWidth */
            (graphArgs->createParams->imgFrameHeight + totalBorderRequired),                /* roiHeight */
            (blkWidthFinal  + totalBorderRequired)*sizeof(uint8_t),                         /* blkWidth */
            blkHeightFinal + totalBorderRequired,                                           /* blkHeight */
            ...
            0,                                                                          /* extMemPtrStride  */
            NULL,                                                                       /* interMemPtr      */
            (blkWidthFinal  + totalBorderRequired)*sizeof(uint8_t),                         /* interMemPtrStride */
            0);                                                                         /* dmaQueNo          */
                                                                  ...
                                                                  uint8_t totalBorder)
{
    ...
    if ( outputFormat == HARRIS_CORNER_DETECTION_32_TI_OUTPUT_FORMAT_LIST )
    {
      ...
      oneShotCtlArgs.extMemPtrStride[1]= 4;
