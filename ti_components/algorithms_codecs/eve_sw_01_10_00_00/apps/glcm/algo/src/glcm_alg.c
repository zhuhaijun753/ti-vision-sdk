...
{
  {
      (void *)&GLCM_TI_VISION_FXNS, /* module ID */
                     ...
                     const IALG_Params *params)
{
  int32_t status = IALG_EOK;
  int32_t bamStatus;
  GLCM_TI_CreateParams *createParams = (GLCM_TI_CreateParams*)(void *)params;
  ...
  algHandle->ivision = (IVISION_Fxns *)&GLCM_TI_VISION_FXNS;
...
#endif
    for(n = 0; n < 8U; n++) {
        (*scatter_offsets)[n] = n*algHandle->scatterOffset;
    }
