...
{
  {
      (void *)&MORPHOLOGY_TI_VISION_FXNS, /* module ID */
                                     ...
                                     const IALG_Params *params)
{
  ...
  MORPHOLOGY_TI_CreateParams *createParams = (MORPHOLOGY_TI_CreateParams *)(void *)params;
  ...
  algHandle->ivision = (IVISION_Fxns *)&MORPHOLOGY_TI_VISION_FXNS;
