...
MEMORY
{
    ...
    PAGE 1:
      ...
      EXTDMEM :    origin = 0x80008000 length = 0xFFFF
}
...
SECTIONS
{
  ...
  .data:         load = DATMEM       PAGE 1
   ...
   DST1_REGION:  load = EXTDMEM      PAGE 1
   DST2_REGION:  load = EXTDMEM      PAGE 1
   DST3_REGION:  load = EXTDMEM      PAGE 1
   DST4_REGION:  load = EXTDMEM      PAGE 1
   DST5_REGION:  load = EXTDMEM      PAGE 1
   DST6_REGION:  load = EXTDMEM      PAGE 1
   DST7_REGION:  load = EXTDMEM      PAGE 1
   DST8_REGION:  load = EXTDMEM      PAGE 1
