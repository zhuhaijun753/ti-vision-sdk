...
DMAUTILS         := $(DSP_SW_ROOT)\dmautils
BASE_ADDRESS_DIR := $(DMAUTILS)/inc/baseaddress/$(TARGET_SOC)/$(CORE)
ifeq ($(TARGET_PLATFORM) , PC)
...
ifeq ($(TARGET_BUILD), release)
  CFLAGS := /EHsc /TP /W0 /DHOST_EMULATION /c /nologo /Ox /MD
  LDDEBUG :=
else
  CFLAGS := /EHsc /TP /W0 /DHOST_EMULATION /c /nologo /Od /MDd /Gm /Zi /RTC1
  LDDEBUG := /DEBUG
endif
