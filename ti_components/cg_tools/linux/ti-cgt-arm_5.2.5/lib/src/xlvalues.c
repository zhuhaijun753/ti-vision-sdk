...
/* extern const */ _Dconst _LInf = {INIT(_FMAX << _FOFF)};
/* extern const */ _Dconst _LNan = {INIT((_FMAX << _FOFF)
	| (1 << (_FOFF - 1)))};
/* extern const */ _Dconst _LSnan = {INIT2(_FMAX << _FOFF, 1)};
/* extern const */ _Dconst _LRteps = { /* sqrt(EPSILON)/2 */
	INIT((_FBIAS - NBITS / 2) << _FOFF)};

 #else /* !defined(_32_BIT_LDOUBLE) */
