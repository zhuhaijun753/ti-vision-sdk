...
Int32 Bsp_sii9127Reset(Bsp_Sii9127HandleObj *pObj)
{
    ...
    {
        /* Normal operation */
        retVal = Bsp_sii9127PowerDown(pObj, FALSE);
        if (FVID2_SOK != retVal)
        {
    ...
    if (FVID2_SOK == retVal)
    {
        ...
        numRegs          = 0;
        regAddr[numRegs] = BSP_SII9127_REG_SRST0;
    ...
    if (FVID2_SOK == retVal)
    {
        ...
        regAddr[numRegs] = BSP_SII9127_REG_FACTORY_A87;
        regVal[numRegs]  = 0x03;
        numRegs++;
        regAddr[numRegs] = BSP_SII9127_REG_FACTORY_A81;
        regVal[numRegs]  = 0x10;
        numRegs++;
        regAddr[numRegs] = BSP_SII9127_REG_FACTORY_A88;
        regVal[numRegs]  = 0x40;
        numRegs++;
                           ...
                           Bsp_VidDecChipIdStatus *pStatus)
{
    ...
    if (FVID2_SOK == retVal)
    {
        ...
        regAddr[numRegs] = BSP_SII9127_REG_VND_IDL;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_VND_IDH;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DEV_IDL;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DEV_IDH;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DEV_REV;
        regVal[numRegs]  = 0;
        numRegs++;
                                ...
                                Bsp_VidDecVideoStatus       *pStatus)
{
    ...
    if (FVID2_SOK == retVal)
    {
        ...
        regAddr[numRegs] = BSP_SII9127_REG_H_RESL;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_H_RESH;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_V_RESL;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_V_RESH;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DE_PIXL;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DE_PIXH;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DE_LINL;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_DE_LINH;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_VID_XPCNT1;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_VID_XPCNT2;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_VID_STAT;
        regVal[numRegs]  = 0;
        numRegs++;

        regAddr[numRegs] = BSP_SII9127_REG_STATE;
        regVal[numRegs]  = 0;
        numRegs++;
...
Int32 Bsp_sii9127Stop(Bsp_Sii9127HandleObj *pObj)
{
    ...
    /* Disable output */
    retVal = Bsp_sii9127OutputEnable(pObj, FALSE);
    if (FVID2_SOK != retVal)
    {
                                   ...
                                   const Bsp_Sii9127AviInfoFrame   *pAviInfo)
{
    ...
    regAddr[numRegs] = BSP_SII9127_REG_VID_MODE;
    regVal[numRegs]  = (insSavEav << 7) /* 1: SAV2EAV enable   , 0: disable */
    ...
    regAddr[numRegs] = BSP_SII9127_REG_VID_MODE2;
    regVal[numRegs]  = ((UInt32)0 << 6)               /* 0: Dither to 8bits, 1: 10bits,
                                               * 2: 12bits  */
    ...
    regAddr[numRegs] = BSP_SII9127_REG_VID_CTRL;
    regVal[numRegs]  = ((UInt32)0 << 7)         /* 0: Do not invert VSYNC, 1: invert */
    ...
    regAddr[numRegs] = BSP_SII9127_REG_SYS_CTRL1;
    regVal[numRegs]  = (inPixRep << 6)   /* 0: Output pixel clock divided 1x,
                                          * 1: 1/2x, 3: 1/4x */
     ...
     */
    chMap = 0x05U;
    regAddr[numRegs] = BSP_SII9127_REG_VID_CH_MAP;
...
static Int32 Bsp_sii9127PowerDown(Bsp_Sii9127HandleObj *pObj, UInt32 powerDown)
{
    ...
    if (FVID2_SOK == retVal)
    {
        ...
        {
            regVal[0] = 0x04;  /* power down  */
        }
        else
        {
            regVal[0] = 0x05;  /* normal operation */
        }
...
static Int32 Bsp_sii9127OutputEnable(Bsp_Sii9127HandleObj *pObj, UInt32 enable)
{
    ...
    regVal[numRegs]  = 0x43;          /* Enable all expect outputs */
    ...
    regVal[numRegs]  = 0xAD;          /* Enable all expect outputs */
    if ((UInt32)TRUE == enable)
    {
        regValue = (UInt32)regVal[numRegs];
                                       ...
                                       UInt32                coreId)
{
    ...
    regAddr[numRegs] = BSP_SII9127_REG_SYS_SWTCHC;
    switch (coreId)
    {
        case 0:
    ...
    regAddr[numRegs] = BSP_SII9127_REG_SYS_SWTCHC2;
