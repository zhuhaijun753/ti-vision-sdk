 ...
 *  \defgroup BSP_DRV_DEVICE_AUDIOICODEC_API Audio ICodec Driver API
 *
 *  @{
 */
 ...
 *  DSP processors.
 *
 *  References -# SYS/BIOS driver development <b>SPRU616.pdf</b>
 *
 *  \file   bsp_audioICodec.h
 *
...
/**
 *  \brief Channel types defintion
 *
 *  This enum defines the audio codec channel types supported in the Audio
 *  Framework.
 */
typedef enum {
...
typedef enum {
    ICodec_DataType_LEFTJ,  /**<Audio Codec serial data type is left justified
                            **/
    ICodec_DataType_RIGHTJ, /**<Audio Codec serial data type is right
                             *justified*/
