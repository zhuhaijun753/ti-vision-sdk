...
void audioUserAic31Init(void)
{
    ...
    audioAic31Params.acDataPath       = ICodec_DataPath_TX;
}
...
void audioUserMcaspInit(void)
{
    ...
    audioMcaspParams.enablecache = TRUE;
    audioMcaspParams.isDataBufferPayloadStructure = FALSE;
    audioMcaspParams.prcmDevId = 0;
}
