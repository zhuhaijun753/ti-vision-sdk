...
CFLAGS_INTERNAL = -Wimplicit -Wall -Wunused -Wunknown-pragmas -ffunction-sections -fdata-sections -mcpu=cortex-a15 -mfpu=neon -mfloat-abi=hard -mabi=aapcs -mapcs-frame -g
CFLAGS_DIROPTS =
...
$(OBJ_PATHS): $(OBJDIR)/%.$(OBJEXT): %.c
	...
	$(CC) -c -MD -MF $(DEPFILE).P $(_CFLAGS) $(INCLUDES) -o $(OBJDIR)/$(basename $(notdir $<)).$(OBJEXT) -x c $<
...
LIB_PATHS_NON_DEP += -lgcc -lc -lm -lrdimon
...
$(EXE_NAME) : $(OBJ_PATHS_ASM) $(OBJ_PATHS) $(EXT_LIB_a15host) $(LNKCMD_FILE) $(LIB_PATHS)
	$(ECHO) \# Linking into $(EXE_NAME)...
	$(ECHO) \#
	$(CC) $(_LNKFLAGS) $(OBJ_PATHS_ASM) $(OBJ_PATHS) -T $(LNKCMD_FILE) -Wl,-Map,$@.map -o $@ $(EXT_LIB_a15host) -Wl,--start-group $(LIB_PATHS) $(LIB_PATHS_NON_DEP) -Wl,--end-group
	$(ECHO) \#
	$(ECHO) \# $@ created.
	$(ECHO) \#
