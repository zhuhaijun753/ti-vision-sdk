 ...
 */
#include "stdint.h"
#include <armv7a/ti814x/hw_intc.h>
#include "cpu.h"
#include "cp15.h"
...
*******************************************************************************/
const uint32_t        TI814X_VECTOR_BASE = 0x40310000U;
...
void CopyVectorTable(void)
{
    uint32_t *dest = (uint32_t *) TI814X_VECTOR_BASE;
     ...
     *
     */
    CP15VectorBaseAddrSet(TI814X_VECTOR_BASE);
