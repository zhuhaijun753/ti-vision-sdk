...
_argArray:
	...
	.equ ADDR_SIR_IRQ, 0x48200040
	.equ ADDR_SIR_FIQ, 0x48200044
	.equ ADDR_CONTROL, 0x48200048

	.equ MASK_ACTIVE_IRQ, 0x0000007F
	.equ MASK_ACTIVE_FIQ, 0x0000007F
	.equ NEWIRQAGR, 0x00000001
	.equ NEWFIQAGR, 0x00000002
...
IRQHandler:
		...
		LDR      r0, =argArray            @ Load base of argument table
