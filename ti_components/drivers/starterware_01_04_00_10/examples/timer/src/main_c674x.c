...
int main(void)
{
    ...
    /* Register Timer4 interrupts on to DSP INTC */
    TimerIntcConfigure();
...
/*
** Do the necessary Timer configurations on to DSP INTC.
*/
static void TimerIntcConfigure(void)
{
    /* Initialize the DSP interrupt control */
    Intc_Init();

    /* Enable the DSP interrupt */
    Intc_IntEnable(0);

    /* Registering TimerIsr */
    Intc_IntRegister(52, (IntrFuncPtr) TimerIsr, NULL);

    /* Set the priority */
    Intc_IntPrioritySet(52, 1, 0);

    /* Enable the system interrupt */
    Intc_SystemEnable(52);
}
