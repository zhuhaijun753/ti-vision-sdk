...
SECTIONS
{
  ...
  .text : { *(.text) }  > DDR3_MPU_CPU0_CODE
  .data : { *(.data) }	> DDR3_MPU_CPU0_DATA
  .bss : { *(.bss) }	> DDR3_MPU_CPU0_DATA
  .const : { *(.const) }	> DDR3_MPU_CPU0_DATA
  .cinit : { *(.cinit) }	> DDR3_MPU_CPU0_DATA
  .stack : { *(.stack) }	> DDR3_MPU_CPU0_STACK
  .my_sect_ddr : { *(.my_sect_ddr) }	> DDR3_MPU_CPU0_DATA
  .cio : { *(CIO) }
