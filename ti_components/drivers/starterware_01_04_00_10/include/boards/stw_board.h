 ...
 *  \return INVALID_INST_NUM        If device is not found.
 */
 ...
 *  \return INVALID_INFO                If device is not found. INVALID_INFO is
 ...
 *  \return INVALID_INST_NUM        If device is not found, or if no
