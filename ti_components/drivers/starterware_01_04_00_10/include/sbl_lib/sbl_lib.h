 ...
 *         app image.
 */
typedef struct sbllibMetaHeaderStart
{
    uint32_t magicStr;
 ...
 *         the meta header of multi-core app image.
 */
typedef struct sbllibMetaHeader
{
    sbllibMetaHeaderStart_t metaHeaderStart;
    /**< Start Meta Header of Multi-core App Image */
    sbllibMetaHeaderCore_t  metaHeaderCore[SBLLIB_MAX_RPRC_IMAGES];
...
/**
 * \brief   This function parses the multi-core App image. It reads the
 ...
 *
 * \param   rprcImageHeader Header of RPRC Image
 ...
 * \param   pmhalPrcmDpllConfig_t Pointer to DPLL structure.
 *
