...
#define VPS_HAL_ISS_IOCTL_GET_BLANKING_INFO (VPS_HAL_ISS_IOCTL_STOP + 1U)
...
#define VPS_HAL_ISS_IOCTL_CAL_BEGIN         (VPS_HAL_ISS_IOCTL_IPIPEIF_END)
...
#define VPS_HAL_ISS_IOCTL_IPIPE_BEGIN       (VPS_HAL_ISS_IOCTL_CAL_END)
