        ...
        if(openPrms->instId == pInstObj->instId)
        {
            ...
            if(0 == pInstObj->openCnt)
            {
                ...
                GT_assert(
                    VpsHalTrace,
                    (FVID2_SOK ==
                     VpsHal_issEnableModule(ISSHAL_ISS_MODULE_H3A, TRUE)));
            }
    ...
    if(pInstObj->openCnt > 0)
    {
        ...
        if(0U == pInstObj->openCnt)
        {
            ...
            GT_assert(
                VpsHalTrace,
                (FVID2_SOK ==
                 VpsHal_issEnableModule(ISSHAL_ISS_MODULE_H3A, FALSE)));
        }
    ...
    Ptr                        arg)
{
    ...
    if(FVID2_SOK == status)
    {
        ...
        regVal = (((cfg->paxelCfg.width / 2U) - 1U) << H3A_AFPAX1_PAXW_SHIFT) &
                 H3A_AFPAX1_PAXW_MASK;
        regVal |=
            (((cfg->paxelCfg.height / 2U) - 1U) << H3A_AFPAX1_PAXH_SHIFT) &
            H3A_AFPAX1_PAXH_MASK;
        HW_WR_REG32(instObj->baseAddress + H3A_AFPAX1, regVal);

        regVal = (((cfg->paxelCfg.horzIncr / 2U) - 1U) <<
                  H3A_AFPAX2_AFINCH_SHIFT) &
                 H3A_AFPAX2_AFINCH_MASK;
        regVal |= (((cfg->paxelCfg.vertIncr / 2U) - 1U) <<
                   H3A_AFPAX2_AFINCV_SHIFT) &
                  H3A_AFPAX2_AFINCV_MASK;
        regVal |= ((cfg->paxelCfg.horzCount - 1U) << H3A_AFPAX2_PAXHC_SHIFT) &
                  H3A_AFPAX2_PAXHC_MASK;
        regVal |= ((cfg->paxelCfg.vertCount - 1U) << H3A_AFPAX2_PAXVC_SHIFT) &
        ...
        if(TRUE == cfg->enableMedFilt)
        {
            ...
            regVal &= ~H3A_PCR_MED_TH_MASK;
            regVal |= (cfg->midFiltThreshold << H3A_PCR_MED_TH_SHIFT) &
                      H3A_PCR_MED_TH_MASK;
        }

        regVal &= ~H3A_PCR_RGBPOS_MASK;
        ...
        regVal &= ~H3A_ADVANCED_AF_MODE_MASK;
    ...
    Ptr                          arg)
{
    ...
    if(FVID2_SOK == status)
    {
        ...
        regVal &= ~H3A_AEWCFG_AEFMT_MASK;
        regVal &= ~H3A_AEWCFG_SUMSHFT_MASK;
        ...
        regVal = (((cfg->winCfg.width / 2U) - 1U) << H3A_AEWWIN1_WINW_SHIFT) &
                 H3A_AEWWIN1_WINW_MASK;
        regVal |=
            (((cfg->winCfg.height / 2U) - 1U) << H3A_AEWWIN1_WINH_SHIFT) &
            H3A_AEWWIN1_WINH_MASK;
        regVal |= ((cfg->winCfg.horzCount - 1U) << H3A_AEWWIN1_WINHC_SHIFT) &
                  H3A_AEWWIN1_WINHC_MASK;
        regVal |= ((cfg->winCfg.vertCount - 1U) << H3A_AEWWIN1_WINVC_SHIFT) &
        ...
        regVal |= (((cfg->blackLineHeight / 2U) + 1U) <<
    ...
    const vpsissH3aAfFirFilrConfig_t *firCfg2)
{
    ...
    regVal = (firCfg1->coeff[0U] << H3A_VFV_CFG1_VCOEF1_0_SHIFT) &
             H3A_VFV_CFG1_VCOEF1_0_MASK;
    regVal |= (firCfg1->coeff[1U] << H3A_VFV_CFG1_VCOEF1_1_SHIFT) &
              H3A_VFV_CFG1_VCOEF1_1_MASK;
    regVal |= (firCfg1->coeff[2U] << H3A_VFV_CFG1_VCOEF1_2_SHIFT) &
              H3A_VFV_CFG1_VCOEF1_2_MASK;
    regVal |= (firCfg1->coeff[3U] << H3A_VFV_CFG1_VCOEF1_3_SHIFT) &
              H3A_VFV_CFG1_VCOEF1_3_MASK;
    HW_WR_REG32(instObj->baseAddress + H3A_VFV_CFG1, regVal);

    regVal = (firCfg1->coeff[4U] << H3A_VFV_CFG2_VCOEF1_4_SHIFT) &
             H3A_VFV_CFG2_VCOEF1_4_MASK;
    regVal |= (firCfg1->threshold << H3A_VFV_CFG2_VTHR1_SHIFT) &
              H3A_VFV_CFG2_VTHR1_MASK;
    HW_WR_REG32(instObj->baseAddress + H3A_VFV_CFG2, regVal);

    /* Set the FIR coefficients */
    regVal = (firCfg2->coeff[0U] << H3A_VFV_CFG3_VCOEF2_0_SHIFT) &
             H3A_VFV_CFG3_VCOEF2_0_MASK;
    regVal |= (firCfg2->coeff[1U] << H3A_VFV_CFG3_VCOEF2_1_SHIFT) &
              H3A_VFV_CFG3_VCOEF2_1_MASK;
    regVal |= (firCfg2->coeff[2U] << H3A_VFV_CFG3_VCOEF2_2_SHIFT) &
              H3A_VFV_CFG3_VCOEF2_2_MASK;
    regVal |= (firCfg2->coeff[3U] << H3A_VFV_CFG3_VCOEF2_3_SHIFT) &
              H3A_VFV_CFG3_VCOEF2_3_MASK;
    HW_WR_REG32(instObj->baseAddress + H3A_VFV_CFG3, regVal);

    regVal = (firCfg2->coeff[4U] << H3A_VFV_CFG4_VCOEF2_4_SHIFT) &
    ...
    const vpsissH3aAfIirFiltConfig_t *iirCfg2)
{
    ...
    for(cnt = 0U; cnt < 2U; cnt++)
    {
        ...
        {
            regVal =
                (tempIirCfg->coeff[iirCnt] << H3A_AFCOEF010_COEFF0_SHIFT) &
                H3A_AFCOEF010_COEFF0_MASK;

            if(iirCnt < (VPS_ISS_H3A_AF_IIR_COEFF_MAX - 2U))
            {
                regVal |= (tempIirCfg->coeff[iirCnt + 1U]
