    ...
    Ptr                       arg)
{
    ...
    for(cnt = 0U; cnt < ISSHAL_NSF3_MAX_COLOR; cnt++)
    {
        ...
        regVal &= ~(NSF3V_SUP_C01_L3_LH_MASK | NSF3V_SUP_C01_L3_HH_MASK);
    ...
    if(FVID2_SOK == status)
    {
        ...
        regVal &= ~(NSF3V_CFG_LBORDER_REP_MASK | NSF3V_CFG_RBORDER_REP_MASK |
    ...
    const vpsissNsf3ShadeGainConfig_t *sgCfg)
{
    ...
    regVal &= ~(NSF3V_SHD_ADJ_GADJ_MASK | NSF3V_SHD_ADJ_OADJ_MASK);
