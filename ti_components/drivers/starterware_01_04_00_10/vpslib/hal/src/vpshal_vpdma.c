...
#include <hal/src/vpshal_vpdmaPriv.h>
#include <hal/src/vpshal_vpdmaFirmwareTda2xx_v288.h>
#include <hal/src/vpshal_vpdmaFirmwareTda2xx_v1B8.h>
#ifdef TDA3XX_FAMILY_BUILD
#include <hal/src/vpshalVpdmaDefaultsTda3xx.h>
#endif
#ifdef TDA2XX_FAMILY_BUILD
#include <hal/src/vpshalVpdmaDefaultsTda2xx.h>
#endif
#ifdef TI814X_FAMILY_BUILD
#include <hal/src/vpshalVpdmaDefaultsTI814x.h>
#endif
                                 ...
                                 VpsHal_VpdmaWriteDescParams *descInfo)
{
    ...
    if ((VPSHAL_VPDMA_ERR_PATTERN == *(volatile Int32 *) wrDescAddr) ||
        (VPSHAL_VPDMA_ERR_PATTERN == *(volatile Int32 *) (tempAddr)))
    {
...
{
    /* TODO: GT_assert(VpsHalTrace, (NULL != memPtr)); */
    /* TODO: GT_assert(VpsHalTrace, (0U == (((UInt32)descAddr & */
    /* TODO:         (VPSHAL_VPDMA_WR_DESC_BUF_ADDR_ALIGN - 1U))))); */
    /* TODO: GT_assert(VpsHalTrace, (0U == ((UInt32)descAddr & */
    /* TODO:         (~VPSHAL_VPDMA_DATADESC_OUTBUFFERMASK)))); */
    ...
    *(volatile Int32 *) wrDescAddr          = VPSHAL_VPDMA_ERR_PATTERN;
    *((volatile Int32 *) (wrDescAddr) + 4U) = VPSHAL_VPDMA_ERR_PATTERN;
}
