...
{298, 409, 0, 298, -208, -100, 298, 0, 517, 0, 0, 0};
static const Vps_DssCscCoeff   gWbCscCoeff =
{66, 129, 25, 112, -94, -18, -38, -74, 112, 0, 0, 0};
    ...
    if (retVal == BSP_SOK)
    {
                 ...
                 (vidConf->inFmt.dataFormat == FVID2_DF_YUV420SP_UV))
        {
            ...
            if (retVal == BSP_SOK)
            {
                ...
                halDssVidConfFir2(handle, (UInt32) (vidConf->inFmt.width / 2),
                                  (UInt32) (vidConf->inFmt.height / 2),
                                  vidConf->outWidth,
                                  vidConf->outHeight);
            }
        ...
        {
            halDssVidConfScalerEnable(
                handle, (UInt32) DSS_DISPC_VID1_ATTRIBUTES_RESIZEENABLE_HRESIZE);
