...
/* Derived from GEL commit ID: a4224d6149e94197ec0981ed241ff7f8c151fd93 */
...
static void EMIF_LPDDR2_Config(uint32_t base_addr)
{
    ...
    {
        SBL_PRINTF(TRACE_LOW, "   !!!!RZQ Self test FAILED.!!!!\n");
        SBL_PRINTF(
            TRACE_LOW,
    ...
    {
        SBL_PRINTF(TRACE_LOW, "   !!!!RZQ Self test FAILED.!!!!\n");
        SBL_PRINTF(TRACE_LOW, "   !!!!ZQ Pin may be connected to Ground.!!!!\n");
    }
    else if (3U == temp)
    {
        SBL_PRINTF(
    ...
    SBL_PRINTF(TRACE_LOW, " ==============================================\n");
    SBL_PRINTF(TRACE_LOW, " ==========  LPDDR2 Device Info      ==========\n");
    SBL_PRINTF(TRACE_LOW, " ==============================================\n");
    ...
    HW_WR_REG32(base_addr + EMIF_LPDDR2_MODE_REG_CONFIG, 0x00000006U);

    HW_WR_REG32(base_addr + EMIF_LPDDR2_MODE_REG_CONFIG, 0x00000007U);
    ...
    if (0U == temp)
    {
        ...
        SBL_PRINTF(TRACE_LOW, "   !!!!Device may not function correctly.!!!!\n");
    }
    else if (7U == temp)
    {
        SBL_PRINTF(TRACE_LOW,
...
static void EMIF_DDR3_UpdateHWLevelOutput(uint32_t base_addr)
{
    ...
    SBL_PRINTF(TRACE_LOW, "       as per HW leveling output\n");
    ...
    SBL_PRINTF(TRACE_LOW, "       PHY_STATUSx registers\n");
}
                        ...
                        uint32_t isEccEnabled)
{
    ...
    if ((1U == isHwLevelingEnabled) && (CFG_MODE_DDR3 == mode))
    {
        ...
        SBL_PRINTF(TRACE_LOW, "       Launch full leveling\n");
        ...
        {
            SBL_PRINTF(TRACE_LOW, "ERROR: HW-Leveling time-out\n");
        }
        else
        {
...
void sbl_ddr3_config(void)
{
    ...
    SBL_PRINTF(TRACE_LOW, ">> START ==> Overall DDR configuration\n");
    ...
    SBL_PRINTF(TRACE_LOW, "--->>> DDR3 Initialization is DONE! <<<---\n");
}
