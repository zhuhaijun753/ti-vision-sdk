...
/* Derived from GEL commit ID: cce050ac1ba52a14ee3984a479e080fd45995dfb */
...
static void TDA2xx_set_lisa_maps(void)
{
    ...
    {
        SBL_PRINTF(TRACE_LOW, "       One EMIF - 256MB total memory\n");
...
#if (EMIF_MODE == DUAL_EMIF_2X512MB)
    {
        SBL_PRINTF(TRACE_LOW,
...
#if (EMIF_MODE == DUAL_EMIF_1GB_512MB)
    {
        SBL_PRINTF(TRACE_LOW,
