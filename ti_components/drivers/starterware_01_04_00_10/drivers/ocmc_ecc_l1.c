...
#define OCMC_VBUF_SIZE (8 * 1024 * 1024)
                           ...
                           uint32_t discardDupErrAddr)
{
    ...
    value = HW_RD_REG32(baseAddr + OCMC_RAM_CFG_OCMC_ECC);
