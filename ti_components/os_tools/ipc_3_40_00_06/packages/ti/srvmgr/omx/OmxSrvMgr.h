...
{
    return ti_srvmgr_omx_OmxSrvMgr_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_srvmgr_omx_OmxSrvMgr_Module_getMask( void ) 
{
    return ti_srvmgr_omx_OmxSrvMgr_Module__diagsMask__C != NULL ? *ti_srvmgr_omx_OmxSrvMgr_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_srvmgr_omx_OmxSrvMgr_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_srvmgr_omx_OmxSrvMgr_Module__diagsMask__C != NULL) *ti_srvmgr_omx_OmxSrvMgr_Module__diagsMask__C = mask;
}
