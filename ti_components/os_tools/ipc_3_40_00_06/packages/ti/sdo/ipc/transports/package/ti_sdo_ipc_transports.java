...
public class ti_sdo_ipc_transports
{
    ...
    void TransportNetworkDummy$$OBJECTS()
    {
        Proto.Obj po, spo;
        Value.Obj vo;

        po = (Proto.Obj)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Module", new Proto.Obj());
        vo = (Value.Obj)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy", new Value.Obj("ti.sdo.ipc.transports.TransportNetworkDummy", po));
        pkgV.bind("TransportNetworkDummy", vo);
        // decls 
        spo = (Proto.Obj)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy$$Instance_State", new Proto.Obj());
        om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", new Proto.Str(spo, false));
        // insts 
        Object insP = om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Instance", new Proto.Obj());
        po = (Proto.Obj)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy$$Object", new Proto.Obj());
        om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Object", new Proto.Str(po, false));
        po = (Proto.Obj)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy$$Params", new Proto.Obj());
        om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Params", new Proto.Str(po, false));
        po = (Proto.Obj)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy$$Instance_State", new Proto.Obj());
        om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", new Proto.Str(po, false));
        om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Handle", insP);
        if (isROV) {
            om.bind("ti.sdo.ipc.transports.TransportNetworkDummy.Object", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", "ti.sdo.ipc.transports"));
        }//isROV
    }
    ...
    void TransportNetworkDummy$$CONSTS()
    {
    ...
    void TransportNetworkDummy$$CREATES()
    {
        Proto.Fxn fxn;
        StringBuilder sb;
        ...
        if (isCFG) {
            sb = new StringBuilder();
            sb.append("ti$sdo$ipc$transports$TransportNetworkDummy$$__initObject = function( inst ) {\n");
                sb.append("if (!this.$used) {\n");
                    sb.append("throw new Error(\"Function ti.sdo.ipc.transports.TransportNetworkDummy.create() called before xdc.useModule('ti.sdo.ipc.transports.TransportNetworkDummy')\");\n");
                sb.append("}\n");
                sb.append("var name = xdc.module('xdc.runtime.Text').defineRopeCord(inst.instance.name);\n");
                sb.append("inst.$object.$$bind('__name', name);\n");
            ...
            sb.append("};\n");
            Global.eval(sb.toString());
            fxn = (Proto.Fxn)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy$$create", new Proto.Fxn(om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Module", "ti.sdo.ipc.transports"), om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance", "ti.sdo.ipc.transports"), 1, 0, false));
                        fxn.addArg(0, "__params", (Proto)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Params", "ti.sdo.ipc.transports"), Global.newObject());
            sb = new StringBuilder();
            sb.append("ti$sdo$ipc$transports$TransportNetworkDummy$$create = function( __params ) {\n");
                sb.append("var __mod = xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy'];\n");
                sb.append("var __inst = xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy.Instance'].$$make();\n");
                sb.append("__inst.$$bind('$package', xdc.om['ti.sdo.ipc.transports']);\n");
                sb.append("__inst.$$bind('$index', __mod.$instances.length);\n");
                sb.append("__inst.$$bind('$category', 'Instance');\n");
                ...
                sb.append("__inst.$$bind('$module', __mod);\n");
                sb.append("__mod.$instances.$add(__inst);\n");
                sb.append("__inst.$$bind('$object', new xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy'].Instance_State);\n");
                sb.append("for (var __p in __params) __inst[__p] = __params[__p];\n");
                sb.append("var save = xdc.om.$curpkg;\n");
                sb.append("xdc.om.$$bind('$curpkg', __mod.$package.$name);\n");
                ...
                sb.append("xdc.om.$$bind('$curpkg', save);\n");
                sb.append("__inst.$$bless();\n");
                sb.append("if (xdc.om.$$phase >= 5) xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy'].__initObject(__inst);\n");
                sb.append("__inst.$$bind('$$phase', xdc.om.$$phase);\n");
                sb.append("return __inst;\n");
            sb.append("}\n");
            Global.eval(sb.toString());
        ...
        if (isCFG) {
            fxn = (Proto.Fxn)om.bind("ti.sdo.ipc.transports.TransportNetworkDummy$$construct", new Proto.Fxn(om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Module", "ti.sdo.ipc.transports"), null, 2, 0, false));
                        fxn.addArg(0, "__obj", (Proto)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Object", "ti.sdo.ipc.transports"), null);
                        fxn.addArg(1, "__params", (Proto)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Params", "ti.sdo.ipc.transports"), Global.newObject());
            sb = new StringBuilder();
            sb.append("ti$sdo$ipc$transports$TransportNetworkDummy$$construct = function( __obj, __params ) {\n");
                sb.append("var __mod = xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy'];\n");
                sb.append("var __inst = __obj;\n");
                sb.append("__inst.$$bind('$args', {});\n");
                sb.append("__inst.$$bind('$module', __mod);\n");
                sb.append("__mod.$objects.$add(__inst);\n");
                sb.append("__inst.$$bind('$object', xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy'].Instance_State.$$make(__inst.$$parent, __inst.$name));\n");
                sb.append("for (var __p in __params) __inst[__p] = __params[__p];\n");
                sb.append("__inst.$$bless();\n");
                sb.append("if (xdc.om.$$phase >= 5) xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy'].__initObject(__inst);\n");
                sb.append("__inst.$$bind('$$phase', xdc.om.$$phase);\n");
    ...
    void TransportNetworkDummy$$FUNCTIONS()
    {
        Proto.Fxn fxn;
    ...
    void TransportNetworkDummy$$SIZES()
    {
        Proto.Str so;
        Object fxn;

        so = (Proto.Str)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", "ti.sdo.ipc.transports");
        sizes.clear();
        sizes.add(Global.newArray("__fxns", "UPtr"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void TransportNetworkDummy$$TYPES()
    {
        Scriptable cap;
        Proto.Obj po;
        Proto.Str ps;
        ...
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Module", "ti.sdo.ipc.transports");
        po.init("ti.sdo.ipc.transports.TransportNetworkDummy.Module", om.findStrict("ti.sdo.ipc.interfaces.INetworkTransport.Module", "ti.sdo.ipc.transports"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
        }//isCFG
        if (isCFG) {
                        po.addFxn("create", (Proto.Fxn)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$create", "ti.sdo.ipc.transports"), Global.get("ti$sdo$ipc$transports$TransportNetworkDummy$$create"));
                        po.addFxn("construct", (Proto.Fxn)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$construct", "ti.sdo.ipc.transports"), Global.get("ti$sdo$ipc$transports$TransportNetworkDummy$$construct"));
        }//isCFG
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance", "ti.sdo.ipc.transports");
        po.init("ti.sdo.ipc.transports.TransportNetworkDummy.Instance", om.findStrict("ti.sdo.ipc.interfaces.INetworkTransport.Instance", "ti.sdo.ipc.transports"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
                        po.addFld("instance", (Proto)om.findStrict("xdc.runtime.IInstance.Params", "ti.sdo.ipc.transports"), $$UNDEF, "w");
        }//isCFG
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Params", "ti.sdo.ipc.transports");
        po.init("ti.sdo.ipc.transports.TransportNetworkDummy.Params", om.findStrict("ti.sdo.ipc.interfaces.INetworkTransport$$Params", "ti.sdo.ipc.transports"));
                po.addFld("$hostonly", $$T_Num, 0, "r");
        if (isCFG) {
                        po.addFld("instance", (Proto)om.findStrict("xdc.runtime.IInstance.Params", "ti.sdo.ipc.transports"), $$UNDEF, "w");
        }//isCFG
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Object", "ti.sdo.ipc.transports");
        po.init("ti.sdo.ipc.transports.TransportNetworkDummy.Object", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance", "ti.sdo.ipc.transports"));
        // struct TransportNetworkDummy.Instance_State
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Instance_State", "ti.sdo.ipc.transports");
        po.init("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Instance_State", "ti.sdo.ipc.transports");
        po.init("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", null);
        po.addFld("$hostonly", $$T_Num, 0, "r");
    ...
    void TransportNetworkDummy$$ROV()
    {
        Proto.Obj po;
        Value.Obj vo;

        vo = (Value.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy", "ti.sdo.ipc.transports");
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Instance_State", "ti.sdo.ipc.transports");
        po.addFld("__fxns", new Proto.Adr("xdc_Ptr", "Pv"), $$UNDEF, "w");
        vo.bind("Instance_State$fetchDesc", Global.newObject("type", "ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy$$Instance_State", "ti.sdo.ipc.transports");
    }
    ...
    void TransportNetworkDummy$$SINGLETONS()
    {
        Proto.Obj po;
        Value.Obj vo;
        ...
        vo = (Value.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy", "ti.sdo.ipc.transports");
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Module", "ti.sdo.ipc.transports");
        vo.init2(po, "ti.sdo.ipc.transports.TransportNetworkDummy", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", $$UNDEF);
        vo.bind("Instance", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance", "ti.sdo.ipc.transports"));
        vo.bind("Params", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Params", "ti.sdo.ipc.transports"));
        vo.bind("PARAMS", ((Proto.Str)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Params", "ti.sdo.ipc.transports")).newInstance());
        vo.bind("Handle", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Handle", "ti.sdo.ipc.transports"));
        vo.bind("$package", om.findStrict("ti.sdo.ipc.transports", "ti.sdo.ipc.transports"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
        ...
        mcfgs.add("Object__table");
        icfgs.add("Object__table");
        vo.bind("Instance_State", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", "ti.sdo.ipc.transports"));
        tdefs.add(om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", "ti.sdo.ipc.transports"));
        vo.bind("$$tdefs", Global.newArray(tdefs.toArray()));
        vo.bind("$$proxies", Global.newArray(proxies.toArray()));
        vo.bind("$$mcfgs", Global.newArray(mcfgs.toArray()));
        vo.bind("$$icfgs", Global.newArray(icfgs.toArray()));
        ...
        if (isCFG) {
            ...
            if (ps != null) vo.bind("$object", ps.newInstance());
            vo.bind("$$meta_iobj", 1);
            vo.bind("__initObject", Global.get("ti$sdo$ipc$transports$TransportNetworkDummy$$__initObject"));
        }//isCFG
        vo.bind("$$fxntab", Global.newArray("ti_sdo_ipc_transports_TransportNetworkDummy_Handle__label__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Module__startupDone__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Object__create__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Object__delete__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Object__destruct__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Object__get__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Object__first__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Object__next__E", "ti_sdo_ipc_transports_TransportNetworkDummy_Params__init__E", "ti_sdo_ipc_transports_TransportNetworkDummy_bind__E", "ti_sdo_ipc_transports_TransportNetworkDummy_unbind__E", "ti_sdo_ipc_transports_TransportNetworkDummy_put__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray());
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.seal("length");
        vo.bind("Object", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Object", "ti.sdo.ipc.transports"));
        vo.bind("Instance_State", om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy.Instance_State", "ti.sdo.ipc.transports"));
        vo.bind("MODULE_STARTUP$", 0);
        vo.bind("PROXY$", 0);
        loggables.clear();
        vo.bind("$$loggables", loggables.toArray());
        pkgV.bind("TransportNetworkDummy", vo);
        ((Value.Arr)pkgV.getv("$unitNames")).add("TransportNetworkDummy");
    }
    ...
    void $$INITIALIZATION()
    {
        ...
        if (isCFG) {
            ...
            Global.put(dstP, "instance", srcP);
            dstP = (Scriptable)((XScriptO)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy", "ti.sdo.ipc.transports")).findStrict("PARAMS", "ti.sdo.ipc.transports");
            Global.put(dstP, "instance", srcP);
        }//isCFG
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.findStrict("ti.sdo.ipc.transports.TransportNetworkDummy", "ti.sdo.ipc.transports"));
        if (isCFG) {
            vo = (Value.Obj)om.findStrict("ti.sdo.ipc.transports.TransportShmCirc", "ti.sdo.ipc.transports");
        ...
        ((Value.Obj)om.getv("ti.sdo.ipc.transports.TransportNetworkDummy")).bless();
    ...
    public void exec( Scriptable xdcO, Session ses )
    {
        ...
        TransportNetworkDummy$$FUNCTIONS();
        TransportShm$$SIZES();
        ...
        TransportNetworkDummy$$SINGLETONS();
        $$INITIALIZATION();
    }
}
