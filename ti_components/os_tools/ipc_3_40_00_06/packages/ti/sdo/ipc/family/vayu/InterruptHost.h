...
{
    return ti_sdo_ipc_family_vayu_InterruptHost_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_family_vayu_InterruptHost_Module_getMask( void ) 
{
    return ti_sdo_ipc_family_vayu_InterruptHost_Module__diagsMask__C != NULL ? *ti_sdo_ipc_family_vayu_InterruptHost_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_family_vayu_InterruptHost_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_family_vayu_InterruptHost_Module__diagsMask__C != NULL) *ti_sdo_ipc_family_vayu_InterruptHost_Module__diagsMask__C = mask;
}
