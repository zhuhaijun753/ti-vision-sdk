...
public class ti_sdo_ipc_family_f28m35x
{
    ...
    void NameServerBlock$$OBJECTS()
    {
        ...
        om.bind("ti.sdo.ipc.family.f28m35x.NameServerBlock.Object", new Proto.Str(po, false));
    ...
    void NotifyDriverCirc$$OBJECTS()
    {
        ...
        om.bind("ti.sdo.ipc.family.f28m35x.NotifyDriverCirc.Object", new Proto.Str(po, false));
    ...
    void TransportCirc$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.sdo.ipc.family.f28m35x.TransportCirc$$Module_State", new Proto.Obj());
        om.bind("ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State", new Proto.Str(spo, false));
        // insts 
        ...
        om.bind("ti.sdo.ipc.family.f28m35x.TransportCirc.Object", new Proto.Str(po, false));
    ...
    void TransportCirc$$CONSTS()
    {
        ...
        om.bind("ti.sdo.ipc.family.f28m35x.TransportCirc.defaultErrFxn", new Extern("ti_sdo_ipc_family_f28m35x_TransportCirc_defaultErrFxn__I", "xdc_Void(*)(ti_sdo_ipc_interfaces_IMessageQTransport_Reason,ti_sdo_ipc_interfaces_IMessageQTransport_Handle,xdc_Ptr,xdc_UArg)", true, false));
    ...
    void TransportCirc$$SIZES()
    {
        ...
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State", "ti.sdo.ipc.family.f28m35x");
        sizes.clear();
        sizes.add(Global.newArray("errFxn", "UFxn"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void TransportCirc$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc$$Module_State", "ti.sdo.ipc.family.f28m35x");
        po.init("ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
    ...
    void TransportCirc$$ROV()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc$$Instance_State", "ti.sdo.ipc.family.f28m35x");
        vo.bind("Module_State$fetchDesc", Global.newObject("type", "ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc$$Module_State", "ti.sdo.ipc.family.f28m35x");
    }
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.sdo.ipc.family.f28m35x$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.sdo.ipc.family.f28m35x$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.sdo.ipc.family.f28m35x$$stat$root'];\n");
        sb.append("}\n");
    ...
    void TransportCirc$$SINGLETONS()
    {
        ...
        vo.bind("Module_State", om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State", "ti.sdo.ipc.family.f28m35x"));
        tdefs.add(om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc.Module_State", "ti.sdo.ipc.family.f28m35x"));
        ...
        vo.bind("defaultErrFxn", om.findStrict("ti.sdo.ipc.family.f28m35x.TransportCirc.defaultErrFxn", "ti.sdo.ipc.family.f28m35x"));
