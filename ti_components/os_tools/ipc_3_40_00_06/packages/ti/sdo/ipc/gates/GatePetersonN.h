...
static inline ti_sdo_ipc_gates_GatePetersonN_Handle ti_sdo_ipc_gates_GatePetersonN_Handle_downCast( ti_sdo_ipc_interfaces_IGateMPSupport_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_sdo_ipc_gates_GatePetersonN_Module__FXNS__C ? (ti_sdo_ipc_gates_GatePetersonN_Handle)i : 0;
}
...
{
    return ti_sdo_ipc_gates_GatePetersonN_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_sdo_ipc_gates_GatePetersonN_Module_getMask( void ) 
{
    return ti_sdo_ipc_gates_GatePetersonN_Module__diagsMask__C != NULL ? *ti_sdo_ipc_gates_GatePetersonN_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_sdo_ipc_gates_GatePetersonN_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_sdo_ipc_gates_GatePetersonN_Module__diagsMask__C != NULL) *ti_sdo_ipc_gates_GatePetersonN_Module__diagsMask__C = mask;
}
