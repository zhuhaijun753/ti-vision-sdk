...
/* FxnTable */
struct ti_ipc_family_tci6638_Interrupt_FxnTable {
    xdc_Fxn func;
    xdc_UArg arg;
};

/* Module_State */
typedef ti_ipc_family_tci6638_Interrupt_FxnTable __T1_ti_ipc_family_tci6638_Interrupt_Module_State__fxnTable;
typedef ti_ipc_family_tci6638_Interrupt_FxnTable *__ARRAY1_ti_ipc_family_tci6638_Interrupt_Module_State__fxnTable;
typedef __ARRAY1_ti_ipc_family_tci6638_Interrupt_Module_State__fxnTable __TA_ti_ipc_family_tci6638_Interrupt_Module_State__fxnTable;
...
xdc__CODESECT(ti_ipc_family_tci6638_Interrupt_Module_startup__E, "ti_ipc_family_tci6638_Interrupt_Module_startup")
__extern xdc_Int ti_ipc_family_tci6638_Interrupt_Module_startup__E( xdc_Int state );
xdc__CODESECT(ti_ipc_family_tci6638_Interrupt_Module_startup__F, "ti_ipc_family_tci6638_Interrupt_Module_startup")
__extern xdc_Int ti_ipc_family_tci6638_Interrupt_Module_startup__F( xdc_Int state );
...
/* isr__I */
#define ti_ipc_family_tci6638_Interrupt_isr ti_ipc_family_tci6638_Interrupt_isr__I
xdc__CODESECT(ti_ipc_family_tci6638_Interrupt_isr__I, "ti_ipc_family_tci6638_Interrupt_isr")
__extern xdc_Void ti_ipc_family_tci6638_Interrupt_isr__I( xdc_UArg arg );
...
{
    return ti_ipc_family_tci6638_Interrupt_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_ipc_family_tci6638_Interrupt_Module_getMask( void ) 
{
    return ti_ipc_family_tci6638_Interrupt_Module__diagsMask__C != NULL ? *ti_ipc_family_tci6638_Interrupt_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_ipc_family_tci6638_Interrupt_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_ipc_family_tci6638_Interrupt_Module__diagsMask__C != NULL) *ti_ipc_family_tci6638_Interrupt_Module__diagsMask__C = mask;
}
...
/* Module_State */
struct ti_ipc_family_tci6638_Interrupt_Module_State {
    xdc_UInt numPlugged;
    xdc_UInt16 clusterId;
    __TA_ti_ipc_family_tci6638_Interrupt_Module_State__fxnTable fxnTable;
};

/* Module__state__V */
extern struct ti_ipc_family_tci6638_Interrupt_Module_State__ ti_ipc_family_tci6638_Interrupt_Module__state__V;
...
#define Interrupt_FxnTable ti_ipc_family_tci6638_Interrupt_FxnTable
#define Interrupt_Module_State ti_ipc_family_tci6638_Interrupt_Module_State
