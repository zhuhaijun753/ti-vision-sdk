...
public class ti_ipc_family_tci6638
{
    ...
    void Interrupt$$OBJECTS()
    {
        ...
        spo = (Proto.Obj)om.bind("ti.ipc.family.tci6638.Interrupt$$FxnTable", new Proto.Obj());
        om.bind("ti.ipc.family.tci6638.Interrupt.FxnTable", new Proto.Str(spo, false));
        spo = (Proto.Obj)om.bind("ti.ipc.family.tci6638.Interrupt$$Module_State", new Proto.Obj());
        om.bind("ti.ipc.family.tci6638.Interrupt.Module_State", new Proto.Str(spo, false));
    }
    ...
    void Interrupt$$CONSTS()
    {
        ...
        om.bind("ti.ipc.family.tci6638.Interrupt.isr", new Extern("ti_ipc_family_tci6638_Interrupt_isr__I", "xdc_Void(*)(xdc_UArg)", true, false));
    }
    ...
    void Interrupt$$SIZES()
    {
        ...
        so = (Proto.Str)om.findStrict("ti.ipc.family.tci6638.Interrupt.FxnTable", "ti.ipc.family.tci6638");
        sizes.clear();
        sizes.add(Global.newArray("func", "UFxn"));
        sizes.add(Global.newArray("arg", "UIArg"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.ipc.family.tci6638.Interrupt.FxnTable']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.ipc.family.tci6638.Interrupt.FxnTable']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.ipc.family.tci6638.Interrupt.FxnTable'], fld); }");
        so.bind("$offsetof", fxn);
        so = (Proto.Str)om.findStrict("ti.ipc.family.tci6638.Interrupt.Module_State", "ti.ipc.family.tci6638");
        sizes.clear();
        sizes.add(Global.newArray("numPlugged", "UInt"));
        sizes.add(Global.newArray("clusterId", "UInt16"));
        sizes.add(Global.newArray("fxnTable", "UPtr"));
        so.bind("$$sizes", Global.newArray(sizes.toArray()));
        fxn = Global.eval("function() { return $$sizeof(xdc.om['ti.ipc.family.tci6638.Interrupt.Module_State']); }");
        so.bind("$sizeof", fxn);
        fxn = Global.eval("function() { return $$alignof(xdc.om['ti.ipc.family.tci6638.Interrupt.Module_State']); }");
        so.bind("$alignof", fxn);
        fxn = Global.eval("function(fld) { return $$offsetof(xdc.om['ti.ipc.family.tci6638.Interrupt.Module_State'], fld); }");
        so.bind("$offsetof", fxn);
    }
    ...
    void Interrupt$$TYPES()
    {
        ...
        po = (Proto.Obj)om.findStrict("ti.ipc.family.tci6638.Interrupt$$FxnTable", "ti.ipc.family.tci6638");
        po.init("ti.ipc.family.tci6638.Interrupt.FxnTable", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
        ...
        po = (Proto.Obj)om.findStrict("ti.ipc.family.tci6638.Interrupt$$Module_State", "ti.ipc.family.tci6638");
        po.init("ti.ipc.family.tci6638.Interrupt.Module_State", null);
                po.addFld("$hostonly", $$T_Num, 0, "r");
                po.addFld("numPlugged", Proto.Elm.newCNum("(xdc_UInt)"), $$UNDEF, "w");
                po.addFld("clusterId", Proto.Elm.newCNum("(xdc_UInt16)"), $$UNDEF, "w");
                po.addFld("fxnTable", new Proto.Arr((Proto)om.findStrict("ti.ipc.family.tci6638.Interrupt.FxnTable", "ti.ipc.family.tci6638"), false), $$DEFAULT, "w");
    }
    ...
    void Interrupt$$ROV()
    {
        ...
        vo.bind("FxnTable$fetchDesc", Global.newObject("type", "ti.ipc.family.tci6638.Interrupt.FxnTable", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.ipc.family.tci6638.Interrupt$$FxnTable", "ti.ipc.family.tci6638");
        vo.bind("Module_State$fetchDesc", Global.newObject("type", "ti.ipc.family.tci6638.Interrupt.Module_State", "isScalar", false));
        po = (Proto.Obj)om.findStrict("ti.ipc.family.tci6638.Interrupt$$Module_State", "ti.ipc.family.tci6638");
        po.bind("fxnTable$fetchDesc", Global.newObject("type", "ti.ipc.family.tci6638.Interrupt.FxnTable", "isScalar", false));
    }
    ...
    void Interrupt$$SINGLETONS()
    {
        ...
        mcfgs.add("DSPINT");
        icfgs.add("DSPINT");
        vo.bind("FxnTable", om.findStrict("ti.ipc.family.tci6638.Interrupt.FxnTable", "ti.ipc.family.tci6638"));
        tdefs.add(om.findStrict("ti.ipc.family.tci6638.Interrupt.FxnTable", "ti.ipc.family.tci6638"));
        vo.bind("Module_State", om.findStrict("ti.ipc.family.tci6638.Interrupt.Module_State", "ti.ipc.family.tci6638"));
        tdefs.add(om.findStrict("ti.ipc.family.tci6638.Interrupt.Module_State", "ti.ipc.family.tci6638"));
        ...
        vo.bind("isr", om.findStrict("ti.ipc.family.tci6638.Interrupt.isr", "ti.ipc.family.tci6638"));
