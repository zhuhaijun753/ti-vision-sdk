...
{
    return ti_ipc_transports_TransportRpmsgSetup_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_ipc_transports_TransportRpmsgSetup_Module_getMask( void ) 
{
    return ti_ipc_transports_TransportRpmsgSetup_Module__diagsMask__C != NULL ? *ti_ipc_transports_TransportRpmsgSetup_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_ipc_transports_TransportRpmsgSetup_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_ipc_transports_TransportRpmsgSetup_Module__diagsMask__C != NULL) *ti_ipc_transports_TransportRpmsgSetup_Module__diagsMask__C = mask;
}
