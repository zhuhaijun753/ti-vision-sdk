...
static inline ti_ipc_transports_TransportRpmsg_Handle ti_ipc_transports_TransportRpmsg_Handle_downCast( ti_sdo_ipc_interfaces_IMessageQTransport_Handle i )
{
    ...
    return (void*)i2->__fxns == (void*)&ti_ipc_transports_TransportRpmsg_Module__FXNS__C ? (ti_ipc_transports_TransportRpmsg_Handle)i : 0;
}
...
{
    return ti_ipc_transports_TransportRpmsg_Module__diagsMask__C != NULL;
}

/* Module_getMask */
static inline xdc_Bits16 ti_ipc_transports_TransportRpmsg_Module_getMask( void ) 
{
    return ti_ipc_transports_TransportRpmsg_Module__diagsMask__C != NULL ? *ti_ipc_transports_TransportRpmsg_Module__diagsMask__C : 0;
}

/* Module_setMask */
static inline xdc_Void ti_ipc_transports_TransportRpmsg_Module_setMask( xdc_Bits16 mask ) 
{
    if (ti_ipc_transports_TransportRpmsg_Module__diagsMask__C != NULL) *ti_ipc_transports_TransportRpmsg_Module__diagsMask__C = mask;
}
