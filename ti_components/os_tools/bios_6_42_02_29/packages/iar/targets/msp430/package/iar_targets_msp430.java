...
public class iar_targets_msp430
{
    ...
    void MSP430X_large$$TYPES()
    {
        ...
        po.addFld("asm", (Proto)om.findStrict("iar.targets.msp430.MSP430X_large.Command", "iar.targets.msp430"), Global.newObject("cmd", "a430", "opts", "-v1 -D__LARGE_DATA_MODEL__ -DUSE_LARGE_CODE_MODEL=1"), "rh");
    ...
    void MSP430X_small$$TYPES()
    {
        ...
        po.addFld("asm", (Proto)om.findStrict("iar.targets.msp430.MSP430X_small.Command", "iar.targets.msp430"), Global.newObject("cmd", "a430", "opts", "-v1 -D__SMALL_DATA_MODEL__ -DUSE_LARGE_CODE_MODEL=1"), "rh");
