...
public class ti_targets_arm_elf
{
    ...
    void IR5$$TYPES()
    {
        ...
        po.addFld("lnk", (Proto)om.findStrict("xdc.bld.ITarget2.Command", "ti.targets.arm.elf"), Global.newObject("cmd", "armlnk", "opts", "--abi=eabi -mv7R5 --strict_compatibility=on"), "rh");
    }
