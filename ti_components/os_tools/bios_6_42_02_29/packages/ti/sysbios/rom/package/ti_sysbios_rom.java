...
public class ti_sysbios_rom
{
    ...
    void ROM$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.rom.ROM.CC1350", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC1350", 2));
        om.bind("ti.sysbios.rom.ROM.CC2650_FLASH", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.CC2650_FLASH", 3));
        om.bind("ti.sysbios.rom.ROM.TM0SXX", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.TM0SXX", 4));
        om.bind("ti.sysbios.rom.ROM.F28004x", xdc.services.intern.xsr.Enum.make((Proto.Enm)om.findStrict("ti.sysbios.rom.ROM.RomName", "ti.sysbios.rom"), "ti.sysbios.rom.ROM.F28004x", 5));
    }
