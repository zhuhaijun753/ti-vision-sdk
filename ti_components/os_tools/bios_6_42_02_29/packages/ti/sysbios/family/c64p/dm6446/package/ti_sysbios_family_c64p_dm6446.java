...
public class ti_sysbios_family_c64p_dm6446
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.sysbios.family.c64p.dm6446$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.sysbios.family.c64p.dm6446$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.sysbios.family.c64p.dm6446$$stat$root'];\n");
        sb.append("}\n");
