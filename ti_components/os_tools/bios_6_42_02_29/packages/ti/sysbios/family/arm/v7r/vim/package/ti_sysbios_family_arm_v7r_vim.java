...
public class ti_sysbios_family_arm_v7r_vim
{
    ...
    void Hwi$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.v7r.vim.Hwi.dispatchFIQC", new Extern("ti_sysbios_family_arm_v7r_vim_Hwi_dispatchFIQC__I", "xdc_Void(*)(xdc_Void)", true, false));
    ...
    void Hwi$$SIZES()
    {
        ...
        sizes.add(Global.newArray("nonDispatchedIRQStack", "UPtr"));
        sizes.add(Global.newArray("nonDispatchedIRQStackSize", "USize"));
    ...
    void Hwi$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("nonDispatchedIRQStack", new Proto.Adr("xdc_Ptr", "Pv"), null, "w");
            po.addFld("nonDispatchedIRQStackSize", Proto.Elm.newCNum("(xdc_SizeT)"), 1024L, "wh");
            po.addFld("nonDispatchedIRQStackSection", $$T_Str, null, "wh");
        ...
        po.init("ti.sysbios.family.arm.v7r.vim.Hwi.Module_State", null);
                ...
                po.addFld("nonDispatchedIRQStack", new Proto.Arr(Proto.Elm.newCNum("(xdc_Char)"), false), $$DEFAULT, "w");
                po.addFld("nonDispatchedIRQStackSize", Proto.Elm.newCNum("(xdc_SizeT)"), $$UNDEF, "w");
    ...
    void Hwi$$ROV()
    {
        ...
        po.bind("nonDispatchedIRQStack$fetchDesc", Global.newObject("type", "xdc.rov.support.ScalarStructs.S_Char", "isScalar", true));
    ...
    void Hwi$$SINGLETONS()
    {
        ...
        mcfgs.add("fiqStack");
        mcfgs.add("nonDispatchedIRQStack");
        ...
        vo.bind("dispatchFIQC", om.findStrict("ti.sysbios.family.arm.v7r.vim.Hwi.dispatchFIQC", "ti.sysbios.family.arm.v7r.vim"));
