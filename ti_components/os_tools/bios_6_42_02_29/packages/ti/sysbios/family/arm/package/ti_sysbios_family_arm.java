...
public class ti_sysbios_family_arm
{
    ...
    void Mpu$$CONSTS()
    {
        ...
        om.bind("ti.sysbios.family.arm.Mpu.initRegions", new Extern("ti_sysbios_family_arm_Mpu_initRegions__I", "xdc_Void(*)(xdc_Void)", true, false));
    ...
    void Mpu$$TYPES()
    {
        ...
        if (isCFG) {
            ...
            po.addFld("enableMPU", $$T_Bool, true, "w");
            po.addFld("enableBackgroundRegion", $$T_Bool, true, "w");
            po.addFld("numRegions", Proto.Elm.newCNum("(xdc_UInt8)"), $$UNDEF, "w");
            po.addFld("regionEntryMeta", new Proto.Arr((Proto)om.findStrict("ti.sysbios.family.arm.Mpu.RegionEntry", "ti.sysbios.family.arm"), false), $$DEFAULT, "wh");
    ...
    void Mpu$$SINGLETONS()
    {
        ...
        vo.bind("initRegions", om.findStrict("ti.sysbios.family.arm.Mpu.initRegions", "ti.sysbios.family.arm"));
        vo.bind("setRegionAsm", om.findStrict("ti.sysbios.family.arm.Mpu.setRegionAsm", "ti.sysbios.family.arm"));
        vo.bind("$$fxntab", Global.newArray("ti_sysbios_family_arm_Mpu_Module__startupDone__E", "ti_sysbios_family_arm_Mpu_disable__E", "ti_sysbios_family_arm_Mpu_disableBR__E", "ti_sysbios_family_arm_Mpu_enable__E", "ti_sysbios_family_arm_Mpu_enableBR__E", "ti_sysbios_family_arm_Mpu_initRegionAttrs__E", "ti_sysbios_family_arm_Mpu_isEnabled__E", "ti_sysbios_family_arm_Mpu_setRegion__E", "ti_sysbios_family_arm_Mpu_startup__E"));
        vo.bind("$$logEvtCfgs", Global.newArray());
        vo.bind("$$errorDescCfgs", Global.newArray());
        vo.bind("$$assertDescCfgs", Global.newArray("A_nullPointer", "A_invalidRegionId"));
        Value.Map atmap = (Value.Map)vo.getv("$attr");
        atmap.setElem("", true);
        atmap.setElem("", "./Mpu.xdt");
        atmap.seal("length");
        vo.bind("MODULE_STARTUP$", 0);
        vo.bind("PROXY$", 0);
        loggables.clear();
        vo.bind("$$loggables", loggables.toArray());
        vo.bind("TEMPLATE$", "./Mpu.xdt");
        pkgV.bind("Mpu", vo);
